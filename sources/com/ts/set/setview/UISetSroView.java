...
public class UISetSroView {
    ...
    public static void Inint(Context tx) {
        ...
        m_llSetMain.setBackgroundColor(Color.parseColor("#ffffff"));
        m_svSetMain.setBackgroundColor(Color.parseColor("#ffffff"));
    ...
    public static void AddView(View vw) {
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(1280, 87);
