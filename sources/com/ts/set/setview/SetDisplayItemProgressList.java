...
public class SetDisplayItemProgressList {
    ...
    public SetDisplayItemProgressList(Context context, int resId) {
        Create(context, resId);
    }

    public SetDisplayItemProgressList(Context context, String strVal) {
    ...
    private void Init(Context context) {
        this.mView = LayoutInflater.from(context).inflate(R.layout.set_diaplay_item_progress_list, (ViewGroup) null);
