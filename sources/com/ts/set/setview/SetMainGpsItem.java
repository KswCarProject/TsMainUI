...
public class SetMainGpsItem {
    ...
    public SetMainGpsItem(Context context, String strVal) {
    ...
    private void Init(Context context) {
        this.mView = LayoutInflater.from(context).inflate(R.layout.gps_main_item, (ViewGroup) null);
        ...
        this.ImageTitle2.setBackgroundResource(R.drawable.setup_main_arrow_up);
    }
}
