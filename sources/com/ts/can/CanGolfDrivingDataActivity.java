...
public class CanGolfDrivingDataActivity extends CanGolfBaseActivity implements View.OnClickListener, UserCallBack {
    ...
    private void ResetData(boolean check) {
        ...
        if (!check || i2b(this.mDisData.Update)) {
            ...
            if (i2b(this.mDisData.DW)) {
                this.mDistance.setText(String.format("%d mi", new Object[]{Integer.valueOf(this.mDisData.Value)}));
            } else {
                this.mDistance.setText(String.format("%d km", new Object[]{Integer.valueOf(this.mDisData.Value)}));
            }
        ...
        if (!check || i2b(this.mAvgSpeedData.Update)) {
            ...
            if (i2b(this.mAvgSpeedData.DW)) {
                this.mAvgSpeed.setText(String.format("Av. %.1f mph", new Object[]{Float.valueOf(((float) this.mAvgSpeedData.Value) / 10.0f)}));
            } else {
                this.mAvgSpeed.setText(String.format("Av. %.1f km/h", new Object[]{Float.valueOf(((float) this.mAvgSpeedData.Value) / 10.0f)}));
            }
        ...
        if (!check || i2b(this.mRangeData.Update)) {
            ...
            if (i2b(this.mRangeData.DW)) {
                this.mRange.setText(String.format("%d mi", new Object[]{Integer.valueOf(this.mRangeData.Value)}));
            } else {
                this.mRange.setText(String.format("%d km", new Object[]{Integer.valueOf(this.mRangeData.Value)}));
            }
        ...
        if (!check || i2b(this.mEleRangeData.Update)) {
            ...
            if (i2b(this.mEleRangeData.DW)) {
                this.mEleRange.setText(String.format("%d mi", new Object[]{Integer.valueOf(this.mEleRangeData.Value)}));
            } else {
                this.mEleRange.setText(String.format("%d km", new Object[]{Integer.valueOf(this.mEleRangeData.Value)}));
            }
        ...
        if (!check || i2b(this.mTotalRangeData.Update)) {
            ...
            if (i2b(this.mTotalRangeData.DW)) {
                this.mTotalRange.setText(String.format("%d mi", new Object[]{Integer.valueOf(this.mTotalRangeData.Value)}));
            } else {
                this.mTotalRange.setText(String.format("%d km", new Object[]{Integer.valueOf(this.mTotalRangeData.Value)}));
            }
    ...
    private void setAvgEletric(boolean check, CanDataInfo.GolfDrivingComm mAvgEletricData) {
        if (!check || i2b(mAvgEletricData.Update)) {
            ...
            if (i2b(mAvgEletricData.DW)) {
                this.mAvgEletric.setText(String.format("Av. %.1f km/kwh", new Object[]{Float.valueOf(((float) mAvgEletricData.Value) / 10.0f)}));
            } else {
                this.mAvgEletric.setText(String.format("Av. %.1f kwh/100km", new Object[]{Float.valueOf(((float) mAvgEletricData.Value) / 10.0f)}));
            }
