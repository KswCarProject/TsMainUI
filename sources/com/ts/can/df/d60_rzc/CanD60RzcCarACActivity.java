...
public class CanD60RzcCarACActivity extends CanCommonActivity implements View.OnTouchListener {
    ...
    public static final String TAG = "CanD60RzcCarACActivity";
    ...
    public static void ShowAC() {
        if (!mIsAC) {
            mfgJump = true;
            CanFunc.showCanActivity(CanD60RzcCarACActivity.class);
        }
    }
