package com.ts.can.df.venucia_rzc;
...
public class CanVenuciaRzcACView extends CanBaseACView {
    ...
    public CanVenuciaRzcACView(Activity activity) {
        super(activity);
    }
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        if (action != 0) {
            if (1 == action) {
                switch (Id) {
                    case 2:
                        CanJni.T90CarAcSet(1, 0);
                        break;
                    case 3:
                        if (this.mACInfo.fgInnerLoop <= 0) {
                            CanJni.T90CarAcSet(4, 0);
                            break;
                        } else {
                            CanJni.T90CarAcSet(5, 0);
                            break;
                        }
                    case 4:
                        CanJni.T90CarAcSet(17, 0);
                        break;
                    case 5:
                        CanJni.T90CarAcSet(6, 0);
                        break;
                    case 6:
                        CanJni.T90CarAcSet(21, 0);
                        break;
                    case 17:
                        CanJni.T90CarAcSet(0, 1);
                        break;
                }
            }
        } else {
            switch (Id) {
                case 2:
                    CanJni.T90CarAcSet(1, 1);
                    break;
                case 3:
                    if (this.mACInfo.fgInnerLoop <= 0) {
                        CanJni.T90CarAcSet(4, 1);
                        break;
                    } else {
                        CanJni.T90CarAcSet(5, 1);
                        break;
                    }
                case 4:
                    CanJni.T90CarAcSet(17, 1);
                    break;
                case 5:
                    CanJni.T90CarAcSet(6, 1);
                    break;
                case 6:
                    CanJni.T90CarAcSet(21, 1);
                    break;
                case 7:
                    ...
                    } else if (this.mACInfo.nLeftTemp < 12) {
                        CanJni.T90CarAcSet(19, this.mACInfo.nLeftTemp + 1);
                        break;
                    }
                    break;
                ...
                case 18:
                    ...
                    break;
                case 19:
                    int temp = this.mACInfo.nWindValue + 1;
                    if (temp >= this.mACInfo.nWindMax) {
                        temp = this.mACInfo.nWindMax;
                    }
                    CanJni.T90CarAcSet(18, temp);
                    break;
                case 21:
    ...
    private void initCommonScreen() {
        ...
        this.mBtnMode = AddBtn(4, 513, 25, R.drawable.can_jeep_ac_mode_up, R.drawable.can_jeep_ac_mode_dn);
    ...
    public void updateACUI() {
        ...
        this.mBtnOff.SetSel(this.mACInfo.nWindValue == 0 ? 1 : 0);
