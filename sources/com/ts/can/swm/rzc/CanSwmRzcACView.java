...
public class CanSwmRzcACView extends CanBaseACView {
    ...
    public CanSwmRzcACView(Activity activity) {
        super(activity);
    }
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        if (action == 0) {
            switch (Id) {
                case 2:
                    CanJni.SwmRzcAirCmd(2, 0, 0, 0, 0, 0);
                    break;
                case 3:
                    CanJni.SwmRzcAirCmd(0, 0, 1, 0, 0, 0);
                    break;
                case 4:
                    CanJni.SwmRzcAirCmd(32, 0, 0, 0, 0, 0);
                    break;
                case 5:
                    CanJni.SwmRzcAirCmd(16, 0, 0, 0, 0, 0);
                    break;
                case 6:
                    CanJni.SwmRzcAirCmd(0, 4, 0, 0, 0, 0);
                    break;
                case 7:
                    CanJni.SwmRzcAirCmd(0, 0, 0, 2, 0, 0);
                    break;
                case 8:
                    CanJni.SwmRzcAirCmd(0, 0, 0, 1, 0, 0);
                    break;
                case 9:
                    CanJni.SwmRzcAirCmd(0, 0, 2, 0, 0, 0);
                    break;
                case 10:
                    CanJni.SwmRzcAirCmd(0, 0, 4, 0, 0, 0);
                    break;
                case 11:
                    CanJni.SwmRzcAirCmd(0, 0, 8, 0, 0, 0);
                    break;
                case 12:
                    CanJni.SwmRzcAirCmd(0, 0, 16, 0, 0, 0);
                    break;
                case 13:
                    CanJni.SwmRzcAirCmd(0, 0, 0, 0, 2, 0);
                    break;
                case 14:
                    CanJni.SwmRzcAirCmd(0, 0, 0, 0, 1, 0);
                    break;
                case 15:
                    CanJni.SwmRzcAirCmd(0, 0, 0, 0, 0, 1);
                    break;
                case 17:
                    CanJni.SwmRzcAirCmd(128, 0, 0, 0, 0, 0);
                    break;
                case 18:
                    CanJni.SwmRzcAirCmd(0, 1, 0, 0, 0, 0);
                    break;
                case 19:
                    CanJni.SwmRzcAirCmd(0, 2, 0, 0, 0, 0);
                    break;
                case 26:
                    CanJni.SwmRzcAirCmd(0, 0, 0, 0, 0, 4);
                    break;
            }
        } else if (1 == action) {
            CanJni.SwmRzcAirCmd(0, 0, 0, 0, 0, 0);
        }
        return false;
    }
