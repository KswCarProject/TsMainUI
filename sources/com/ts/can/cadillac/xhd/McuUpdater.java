...
/* compiled from: CanCadillacAtsXhdUpdateActivity */
class McuUpdater {
    ...
    public int main() {
        ...
        if (!(this.m_IapData.UpdateOnce == 0 || this.m_IapData.Update == 0)) {
            ...
            Log.d("SendData", "m_IapDataDex.Sta = " + this.m_IapData.Sta);
    ...
    public com.ts.can.cadillac.xhd.McuUpdater.FileInfo getFileData(java.lang.String r9) {
        /*
            r8 = this;
            com.ts.can.cadillac.xhd.McuUpdater$FileInfo r5 = new com.ts.can.cadillac.xhd.McuUpdater$FileInfo
            r5.<init>()
            r7 = 0
            r5.len = r7
        ...
        L_0x0080:
            ...
            goto L_0x003f
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ts.can.cadillac.xhd.McuUpdater.getFileData(java.lang.String):com.ts.can.cadillac.xhd.McuUpdater$FileInfo");
    }
