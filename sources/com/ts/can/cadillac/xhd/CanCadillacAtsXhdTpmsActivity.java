...
public class CanCadillacAtsXhdTpmsActivity extends CanBaseActivity implements UserCallBack, View.OnClickListener, CanItemProgressList.onPosChange {
    public static final int ITEM_VOL = 0;
    public static final String TAG = "CanCadillacAtsXhdTpmsActivity";
    ...
    public String GetPressStr(int press) {
        ...
        return String.format("%d kpa", new Object[]{Integer.valueOf(press * 4)});
    }
