...
public class CanCadillacAtsXhdCarInfoActivity extends CanCommonActivity {
    ...
    public void onClick(View v) {
        switch (((Integer) v.getTag()).intValue()) {
            case 0:
                enterSubWin(CanCadillacAtsXhdCarTypeActivity.class);
                return;
            case 1:
                enterSubWin(CanCadillacAtsXhdCarStatusActivity.class);
                return;
            case 2:
                enterSubWin(CanCadillacAtsXhdUpdateActivity.class);
                return;
            case 3:
                enterSubWin(CanCadillacAtsXhdTpmsActivity.class);
                return;
            case 4:
                enterSubWin(CanCadillacAtsXhdCarFuncActivity.class);
                return;
            case 5:
                enterSubWin(CanCadillacAtsXhdCarAirSetActivity.class);
                return;
            default:
                return;
        }
