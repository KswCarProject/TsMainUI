...
public class CanCadillacAtsACUI implements UserCallBack {
    public static final String TAG = "CanCadillacAtsACUI";
    protected static Context mContext;
    static CanCadillacAtsACUI mInstance;
    ...
    protected CanCadillacAtsACUI() {
    }

    public static CanCadillacAtsACUI GetInstance() {
        if (mInstance == null) {
            mInstance = new CanCadillacAtsACUI();
        }
        return mInstance;
    }
    ...
    private void updateACUI() {
        ...
        if (this.mBtnLtHot != null) {
            ...
            if (this.mACInfo.nLtChairWind == 0) {
        ...
        if (this.mBtnRtHot != null) {
            ...
            if (this.mACInfo.nRtChairWind == 0) {
    ...
    public void UserAll() {
        if ((CanJni.GetSubType() == 5 || CanJni.GetSubType() == 4 || CanJni.GetSubType() == 6 || CanJni.GetSubType() == 8) && mIsAC) {
            ResetData(true);
        }
    }
