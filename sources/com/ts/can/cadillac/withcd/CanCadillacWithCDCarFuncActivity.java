...
public class CanCadillacWithCDCarFuncActivity extends CanCommonActivity implements CanItemPopupList.onPopItemClick, CanItemProgressList.onPosChange {
    private static final int ITEM_CAMERA = 0;
    private static final int ITEM_CAR_VEDIO = 2;
    private static final int ITEM_R_CAMERA = 1;
    private static int m_Camerb = 0;
    private static int m_CarVediob = 0;
    private static int m_RCamerb = 0;
    private String[] mCameraArr = {"加装(CVBS)模式", "原车模式"};
    private CanItemPopupList mItemCamera;
    private CanItemPopupList mItemCarVedio;
    private CanItemSwitchList mItemRCamera;
    private CanScrollList mManager;
    private String[] mVedioArr = {"8836 LVDS", "8836 RGB"};
    ...
    public void InitUI() {
        ...
        this.mItemCarVedio = AddPopupItem(R.string.can_cadillac_car_vedio, this.mVedioArr, 2);
    }
    ...
    public void ResetData(boolean check) {
        if (m_Camerb != FtSet.Getlgb1() || m_RCamerb != FtSet.Getlgb2() || m_CarVediob != FtSet.Getlgb3() || !check) {
            m_Camerb = FtSet.Getlgb1();
            m_RCamerb = FtSet.Getlgb2();
            m_CarVediob = FtSet.Getlgb3();
            this.mItemCamera.SetSel(FtSet.Getlgb1());
            this.mItemRCamera.SetCheck(FtSet.Getlgb2());
            this.mItemCarVedio.SetSel(FtSet.Getlgb3());
        }
    }
