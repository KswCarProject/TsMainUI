...
/* compiled from: CanCadillacWithCDUpdateActivity */
class McuUpdater {
    private static final String MCU_FILE = "cadillac_can.bin";
    ...
    private CanDataInfo.CadillacUpdate m_IapData = new CanDataInfo.CadillacUpdate();
    private CanDataInfo.CadillacUpdateDex m_IapDataDex = new CanDataInfo.CadillacUpdateDex();
    ...
    public int main() {
        CanJni.CadillacWithCDGetUpdate(this.m_IapData);
        if (!(this.m_IapData.UpdateOnce == 0 || this.m_IapData.Update == 0)) {
            ...
            } else if (this.m_IapData.Sta == 2 || this.m_IapData.Sta == 3 || this.m_IapData.Sta == 9 || this.m_IapData.Sta == 11 || this.m_IapData.Sta == 12 || this.m_IapData.Sta == 13 || this.m_IapData.Sta == 15 || this.m_IapData.Sta == 15) {
                this.mIsUpdating = false;
            }
        }
        CanJni.CadillacWithCDGetUpdateDex(this.m_IapDataDex);
        if (!(this.m_IapDataDex.UpdateOnce == 0 || this.m_IapDataDex.Update == 0)) {
            this.m_IapDataDex.Update = 0;
            Log.d("SendData", "m_IapDataDex.Dex = " + this.m_IapDataDex.Dex);
            if (this.mIsUpdating) {
                if (this.mIapDexb != this.m_IapDataDex.Dex || this.mIapDexCnt > 5) {
                    this.mIapDexCnt = 0;
                    this.mIapDexb = this.m_IapDataDex.Dex;
                    sendFileData(this.m_IapDataDex.Dex);
                } else {
                    this.mIapDexCnt++;
                }
            }
    ...
    private void sendStart() {
        ...
        this.mSendData[4] = 0;
        this.mSendData[5] = 0;
        this.mSendData[6] = -106;
        this.mSendData[7] = 0;
        this.mSendData[8] = 65;
        this.mSendData[9] = 66;
        this.mSendData[10] = 67;
        this.mSendData[11] = 68;
        this.mSendData[12] = 18;
        this.mSendData[13] = 52;
        this.mSendData[14] = 86;
        this.mSendData[15] = 120;
        for (int i = 1; i < 16; i++) {
            chk = (byte) (this.mSendData[i] + chk);
        }
        this.mSendData[16] = (byte) (chk ^ 255);
        Send(17);
        try {
            Thread.sleep(50);
    ...
    private void sendCrc() {
        int chk = 0;
        for (int i = 0; i < this.m_Fileinfo.len; i++) {
            chk += this.m_Fileinfo.data[i] & 255;
        }
        this.mSendData[0] = 46;
        this.mSendData[1] = -32;
        this.mSendData[2] = 9;
        this.mSendData[3] = 2;
        this.mSendData[4] = (byte) ((this.m_Fileinfo.len >> 24) & 255);
        this.mSendData[5] = (byte) ((this.m_Fileinfo.len >> 16) & 255);
        this.mSendData[6] = (byte) ((this.m_Fileinfo.len >> 8) & 255);
        this.mSendData[7] = (byte) (this.m_Fileinfo.len & 255);
        this.mSendData[8] = (byte) ((chk >> 24) & 255);
        this.mSendData[9] = (byte) ((chk >> 16) & 255);
        this.mSendData[10] = (byte) ((chk >> 8) & 255);
        this.mSendData[11] = (byte) (chk & 255);
        int chk2 = 0;
        for (int i2 = 1; i2 < 12; i2++) {
            chk2 += this.mSendData[i2];
        }
        this.mSendData[12] = (byte) (chk2 ^ 255);
        Send(13);
        try {
            Thread.sleep(50);
        } catch (InterruptedException e) {
    ...
    public void sendFileData(int offset) {
        ...
        if (pos + 64 < this.m_Fileinfo.len) {
            ...
            this.mSendData[1] = -32;
            this.mSendData[2] = 67;
            this.mSendData[3] = WrcManager.WrcCallback.KEY_CENTER;
            this.mSendData[4] = (byte) ((offset >> 8) & 255);
            this.mSendData[5] = (byte) (offset & 255);
            for (int i = 0; i < 64; i++) {
            ...
            this.mSendData[70] = (byte) (chk ^ 255);
            Send(71);
    ...
    public com.ts.can.cadillac.withcd.McuUpdater.FileInfo getFileData(java.lang.String r9) {
        /*
            r8 = this;
            com.ts.can.cadillac.withcd.McuUpdater$FileInfo r5 = new com.ts.can.cadillac.withcd.McuUpdater$FileInfo
            r5.<init>()
            r7 = 0
            r5.len = r7
        ...
        L_0x0080:
            ...
            goto L_0x003f
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ts.can.cadillac.withcd.McuUpdater.getFileData(java.lang.String):com.ts.can.cadillac.withcd.McuUpdater$FileInfo");
    }
