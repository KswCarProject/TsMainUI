...
public class CanZtY100BaseActivity extends CanBaseActivity implements View.OnClickListener {
    public static final int ITEM_STA = 1;
    public static final int ITEM_WARN = 2;
    public static final String TAG = "CanZtY100BaseActivity";
    protected ParamButton mBtnStatus;
    protected ParamButton mBtnWarn;
    protected CanZtY100Item[] mItemWarn = new CanZtY100Item[20];
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_can_zty100_base);
        this.mManager = new RelativeLayoutManager(this, R.id.can_comm_layout);
        this.mBtnWarn = this.mManager.AddButton(0, 96, 267, 92);
        this.mBtnStatus = this.mManager.AddButton(0, 2, 267, 92);
        this.mBtnWarn.setDrawable(R.drawable.can_zt_xx_icon_up, R.drawable.can_zt_xx_icon_dn);
        this.mBtnWarn.setText("故障");
        ...
        for (int i = 0; i < this.mItemWarn.length; i++) {
            this.mItemWarn[i] = new CanZtY100Item(this);
    ...
    public CanZtY100Item AddStaLine(String strTitle) {
        CanZtY100Item item = new CanZtY100Item(this);
        item.SetText(strTitle);
        item.GetTitleTv().setTextColor(-16711681);
        item.GetValTv().setTextColor(-16776961);
        this.mStaManager.AddView(item.GetView(), 684, 57);
        return item;
    }
    ...
    public void AddWarn(String strWarn) {
        if (this.mWarnNum < this.mItemWarn.length) {
            ...
            this.mWarnManager.AddView(this.mItemWarn[this.mWarnNum].GetView(), 684, 57);
            this.mWarnNum++;
        }
    }
