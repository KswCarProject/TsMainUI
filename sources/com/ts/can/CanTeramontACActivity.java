...
public class CanTeramontACActivity extends CanBaseActivity implements UserCallBack, View.OnClickListener {
    ...
    private static final int BTN_REAR_OFF = 25;
    ...
    private static final int BTN_UP_WIND = 26;
    ...
    private void initCommon() {
        ...
        this.mAutoWind = getResources().getStringArray(R.array.can_golf_scr_zdmsfl);
        this.mAQSArray = getResources().getStringArray(R.array.can_golf_scr_zdnwxh);
    ...
    private void ResetData(boolean check) {
        ...
        if (!check || i2b(this.mRearAir.Update)) {
            ...
            if (this.window != null && this.window.isShowing() && this.windowId == 9) {
                ...
                this.acOff.SetSel(Neg(this.mRearAir.bPowerFlg));
            }
        }
    }
    ...
    public void updateACUI() {
        ...
        if (this.window != null && this.window.isShowing()) {
            if (this.windowId == 8) {
                ...
                this.upWind.SetSel(mACInfo.fgUpWind);
    ...
    public void onClick(View v) {
        ...
        switch (((Integer) v.getTag()).intValue()) {
            ...
            case 4:
                ...
                return;
            case 5:
                CanJni.GolfSendCmd(178, Neg(mACInfo.PWR));
                return;
            case 6:
            ...
            case 7:
                ...
                return;
            case 8:
                showWindow(v, CanCameraUI.BTN_SENOVA_SUB_BJ40_MODE1, 120);
                return;
            case 9:
            ...
            case 26:
                if (this.windowId == 8) {
                    CanJni.GolfSendCmd(182, Neg(mACInfo.fgUpWind));
                    return;
                }
                return;
            default:
    ...
    private void addACViews(RelativeLayout contentView) {
        ...
        if (this.windowId == 9) {
            ...
            increaseWind.setOnClickListener(this);
            y = 80;
            this.acOff = manager.AddImage(10, 80);
            this.acOff.setStateDrawable(R.drawable.can_conditioning_off_up, R.drawable.can_conditioning_off_dn, R.drawable.can_conditioning_off_dn);
            this.acOff.setTag(25);
            this.acOff.setOnClickListener(this);
        } else if (this.windowId == 8) {
            y = 25;
            this.acStatus = manager.AddImage(10, 25);
            ...
            this.maxStatus = manager.AddImage(Can.CAN_TEANA_OLD_DJ, 25);
            ...
            this.upWind = manager.AddImage(CanCameraUI.BTN_CHANA_ALSVINV7_MODE1, 20);
            this.upWind.setStateDrawable(R.drawable.can_rh7_icon05_up, R.drawable.can_rh7_icon05_dn, R.drawable.can_rh7_icon05_dn);
            this.upWind.setTag(26);
            this.upWind.setOnClickListener(this);
        }
        this.autoStatus = manager.AddImage(114, y);
        ...
        this.pallaxWind = manager.AddImage(KeyDef.RKEY_MEDIA_10, y - 5);
        ...
        this.downWind = manager.AddImage(426, y - 5);
    ...
    private void addArrayView(RelativeLayout contentView, String[] array) {
        ...
        for (int i = 0; i < array.length; i++) {
            ...
            this.arrayViews[i].setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    CanJni.GolfSendCmd(CanTeramontACActivity.this.windowId == 10 ? 177 : 176, ((Integer) v.getTag()).intValue());
                    CanTeramontACActivity.this.window.dismiss();
                    CanFunc.mLastACTick = CanTeramontACActivity.GetTickCount();
                }
            });
            if (i < array.length - 1) {
