...
public class CanMahindraWcCarInfoView extends CanScrollCarInfoView {
    public CanMahindraWcCarInfoView(Activity activity) {
        super(activity, 1);
    }
    ...
    public void InitData() {
        this.mItemTitleIds = new int[]{R.string.can_car_info};
