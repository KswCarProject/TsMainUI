...
public class CanFordCarTypeActivity extends CanFordBaseActivity implements View.OnClickListener, UserCallBack, CanItemPopupList.onPopItemClick {
    private static final int ITEM_MAX = 1;
    private static final int ITEM_MIN = 1;
    public static final int ITEM_TYPE = 1;
    public static final String TAG = "CanFordCarTypeActivity";
    ...
    public void InitUI() {
        ...
        if (226 == CanJni.GetCanFsTp()) {
            this.mTypeArr = getResources().getStringArray(R.array.can_fs_declare_226);
        } else {
            this.mTypeArr = getResources().getStringArray(R.array.can_fs_declare_13);
        }
