...
public class CanFordFiestaWcCarInfoView extends CanScrollCarInfoView {
    public CanFordFiestaWcCarInfoView(Activity activity) {
        super(activity, 2);
    }
    ...
    public void InitData() {
        this.mItemTitleIds = new int[]{R.string.can_mzd_cx4_setup, R.string.can_warn_msg};
