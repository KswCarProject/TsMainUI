...
public class CanFordRzcCarInfoView extends CanScrollCarInfoView {
    ...
    public void InitData() {
        this.mItemTitleIds = new int[]{R.string.can_car_type_select, R.string.can_car_config, R.string.can_car_lang, R.string.can_car_set, R.string.can_fwddtsz, R.string.can_amp_set, R.string.can_tmps, R.string.can_chair_set};
        this.mItemTypes = new CanScrollCarInfoView.Item[]{CanScrollCarInfoView.Item.CAR_TYPE, CanScrollCarInfoView.Item.POP, CanScrollCarInfoView.Item.POP, CanScrollCarInfoView.Item.TITLE, CanScrollCarInfoView.Item.TITLE, CanScrollCarInfoView.Item.TITLE, CanScrollCarInfoView.Item.TITLE, CanScrollCarInfoView.Item.TITLE};
        ...
        this.mItemVisibles = new int[]{1, 1, 1, this.mAdtData.SetEnable, 1, 1, 1, 1};
