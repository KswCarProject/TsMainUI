...
public class CanObdBnrCarSetView extends CanRelativeCarInfoView {
    public static final String TAG = "CanObdBnrCarSetView";
    ...
    public CanObdBnrCarSetView(Activity activity) {
        super(activity);
    }
    ...
    public void ResetData(boolean check) {
        ...
        if (!check || i2b(this.mSetData.Update)) {
            ...
            if (!i2b(this.mSetData.DriveSafe)) {
            ...
            this.mElctricItem.setText(String.format("--", new Object[]{Float.valueOf(((float) this.mSetData.BatV) * 0.01f)}));
            this.mDistanceItem.setText(String.format("--", new Object[]{Integer.valueOf(this.mSetData.Distance)}));
            this.mOilItem.setText(String.format("--", new Object[]{Integer.valueOf(this.mSetData.Syyl)}));
            this.mLqywdItemTxt.setText(String.format("%d℃", new Object[]{Byte.valueOf((byte) this.mSetData.Lqywd)}));
            this.mXhlcItem.setText(String.format("--", new Object[]{Integer.valueOf(this.mSetData.EndurOil)}));
            showDoor(0, 0, 0, 0, this.mSetData.RearOpen, 0);
            if (i2b(this.mSetData.RearOpen)) {
