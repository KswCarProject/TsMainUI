...
public class CanSciDstCarSetView extends CanRelativeCarInfoView {
    public static final String TAG = "CanSciDstCarSetView";
    ...
    private CanDataInfo.SciDst_CarData mSetData;
    ...
    private CustomImgView mXhlcIcon;
    private TextView mXhlcItem;
    private TextView mXhlcItemTxt;

    public CanSciDstCarSetView(Activity activity) {
        super(activity);
    }
    ...
    public void InitUI() {
        this.mSetData = new CanDataInfo.SciDst_CarData();
    ...
    private void InitUI_1024x600() {
        ...
        this.mXhlcIcon = addImageState(734, KeyDef.RKEY_MEDIA_OSD, R.drawable.canvw_washing_up, R.drawable.canvw_washing_dn);
        ...
        this.mTempItem = addText(137, 210, R.string.can_lqywd);
        ...
        this.mTempItemTxt = addText(117, 180, R.string.can_lqywd);
        ...
        this.mXhlcItemTxt = addText(859, (int) KeyDef.RKEY_MEDIA_SLOW, R.string.can_range_xhlc);
    ...
    private void InitUI_1280x480() {
        ...
        this.mXhlcIcon = addImageState(714, KeyDef.RKEY_MEDIA_OSD, R.drawable.canvw_washing_up, R.drawable.canvw_washing_dn);
        ...
        this.mTempItemTxt = addText(97, 180, R.string.can_lqywd);
        ...
        this.mXhlcItemTxt = addText((int) KeyDef.SKEY_RETURN_1, (int) KeyDef.RKEY_MEDIA_SLOW, R.string.can_range_xhlc);
    ...
    public void ResetData(boolean check) {
        CanJni.ObdDstGetCarData(this.mSetData);
        if (i2b(this.mSetData.UpdateOnce2) && (!check || i2b(this.mSetData.Update2))) {
            this.mSetData.Update2 = 0;
        ...
        if (i2b(this.mSetData.UpdateOnce3) && (!check || i2b(this.mSetData.Update3))) {
            this.mSetData.Update3 = 0;
            this.mRPMItem.setText(String.format("%dRPM", new Object[]{Integer.valueOf(this.mSetData.Rpm)}));
            this.mSpeedItem.setText(String.format("%d Km/h", new Object[]{Integer.valueOf(this.mSetData.Speed)}));
            this.mElctricItem.setText(String.format("%.2fV", new Object[]{Float.valueOf(((float) this.mSetData.BatV) * 0.01f)}));
            this.mDistanceItem.setText(String.format("%dKm", new Object[]{Integer.valueOf(this.mSetData.Xclc)}));
            this.mOilItem.setText(String.format("%dL", new Object[]{Integer.valueOf(this.mSetData.Syyl)}));
            this.mLqywdItemTxt.setText(String.format("%d℃", new Object[]{Integer.valueOf(this.mSetData.Lqywd)}));
        }
        if (i2b(this.mSetData.UpdateOnce4) && (!check || i2b(this.mSetData.Update4))) {
            this.mSetData.Update4 = 0;
            this.mXhlcItem.setText(String.format("%dKm", new Object[]{Integer.valueOf(this.mSetData.Xhlc)}));
        }
        if (!i2b(this.mSetData.UpdateOnce5)) {
            return;
        }
        if (!check || i2b(this.mSetData.Update5)) {
            this.mSetData.Update5 = 0;
            boolean fgWarnOil = i2b(this.mSetData.Yljg);
            boolean fgWarnBat = i2b(this.mSetData.Dcdyjg);
            boolean fgQSY = i2b(this.mSetData.Lqywdjg);
            this.mOilIcon.setSelected(fgWarnOil);
            this.mBatteryIcon.setSelected(fgWarnBat);
            if (fgQSY) {
                this.mLqywdIcon.setSelected(true);
                if (this.mSetData.Lqywdjg == 1) {
                    this.mTempItem.setText(R.string.can_wash_low);
                } else if (this.mSetData.Lqywdjg == 2) {
                    this.mTempItem.setText(R.string.can_wash_high);
                }
            } else {
                this.mLqywdIcon.setSelected(false);
                this.mTempItem.setText(R.string.can_normal);
            }
        }
    }
