...
public class CanGolfLangSetActivity extends CanGolfBaseActivity implements CanItemPopupList.onPopItemClick, UserCallBack {
    ...
    protected int[] mLangVal = {R.string.lang_deutsch, R.string.lang_en_uk, R.string.lang_en_us, R.string.lang_francais, R.string.lang_itanliano, R.string.lang_espanol, R.string.lang_portugues, R.string.lang_polski, R.string.lang_cestina, R.string.lang_Magyar, R.string.lang_dansk, R.string.lang_svenska, R.string.lang_nederlands, R.string.lang_pyccknn, R.string.lang_greek, R.string.lang_Korean, R.string.lang_turkce, R.string.lang_cn, R.string.lang_norsk, R.string.lang_Hrvatski};
