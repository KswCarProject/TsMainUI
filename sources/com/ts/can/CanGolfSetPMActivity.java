...
public class CanGolfSetPMActivity extends CanGolfBaseActivity implements View.OnClickListener, CanItemProgressList.onPosChange, UserCallBack {
    ...
    public void InitItem(int item) {
        switch (item) {
            ...
            case 2:
                ...
                return;
            case 3:
                this.mItemFrontVol = new CanItemProgressList((Context) this, R.string.can_front_vol);
                this.mItemFrontVol.SetIdCallBack(3, this);
                this.mItemFrontVol.SetMinMax(1, 9);
                return;
            case 4:
                this.mItemFrontTone = new CanItemProgressList((Context) this, R.string.can_front_tone);
                this.mItemFrontTone.SetIdCallBack(4, this);
                this.mItemFrontTone.SetMinMax(1, 9);
                return;
            case 5:
                this.mItemRearVol = new CanItemProgressList((Context) this, R.string.can_rear_vol);
                this.mItemRearVol.SetIdCallBack(5, this);
                this.mItemRearVol.SetMinMax(1, 9);
                return;
            case 6:
                this.mItemRearTone = new CanItemProgressList((Context) this, R.string.can_rear_tone);
