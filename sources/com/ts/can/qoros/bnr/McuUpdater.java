...
/* compiled from: CanQorosBnrUpdateActivity */
class McuUpdater {
    ...
    private CanDataInfo.QorosBnrUpdate m_IapData = new CanDataInfo.QorosBnrUpdate();
    ...
    public int main() {
        CanJni.QorosBnrGetUpdataInfo(this.m_IapData);
        if (!(this.m_IapData.UpdateOnce == 0 || this.m_IapData.Update == 0)) {
            this.m_IapData.Update = 0;
            this.mRevUpdateAck = true;
            setIapSta(this.m_IapData.Dex);
            Log.d("SendData", "m_IapDataDex.Sta = " + this.m_IapData.Dex);
            if (this.m_IapData.Dex == 65534) {
                this.mIapDex = 0;
                if (this.mIsUpdating) {
                    sendCrc();
                }
            } else if (this.m_IapData.Dex == 65533) {
                this.mIsUpdating = false;
            } else if (this.m_IapData.Dex != 65535 && this.mIsUpdating) {
                if (this.mIapDexb != this.m_IapData.Dex || this.mIapDexCnt > 5) {
                    this.mIapDexCnt = 0;
                    this.mIapDexb = this.m_IapData.Dex;
                    sendFileData(this.m_IapData.Dex);
                } else {
                    this.mIapDexCnt++;
                }
            }
    ...
    public com.ts.can.qoros.bnr.McuUpdater.FileInfo getFileData(java.lang.String r9) {
        /*
            r8 = this;
            com.ts.can.qoros.bnr.McuUpdater$FileInfo r5 = new com.ts.can.qoros.bnr.McuUpdater$FileInfo
            r5.<init>()
            r7 = 0
            r5.len = r7
        ...
        L_0x0080:
            ...
            goto L_0x003f
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ts.can.qoros.bnr.McuUpdater.getFileData(java.lang.String):com.ts.can.qoros.bnr.McuUpdater$FileInfo");
    }
