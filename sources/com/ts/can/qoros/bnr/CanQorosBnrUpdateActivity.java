...
public class CanQorosBnrUpdateActivity extends Activity {
    public static final String TAG = "CanQorosBnrUpdateActivity";
    ...
    private View.OnClickListener McuUpdateClick = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            if (id == R.id.mcu_update_start) {
                CanQorosBnrUpdateActivity.this.mUpdater.startUpdate();
            } else if (id == R.id.mcu_update_reset && CanQorosBnrUpdateActivity.this.mUpdater.getIapSta() == 65535) {
                Mcu.SendXKey(19);
            }
        }
    };
    ...
    public Runnable runnable = new Runnable() {
        public void run() {
            CanQorosBnrUpdateActivity.this.onTimer();
            CanQorosBnrUpdateActivity.handler.postDelayed(CanQorosBnrUpdateActivity.this.runnable, 30);
        }
    };
