...
public class CanQorosBnrCarTypeActivity extends CanCommonActivity implements CanItemPopupList.onPopItemClick {
    ...
    /* access modifiers changed from: protected */
    public void InitUI() {
        this.mCarTypeArray = getResources().getStringArray(R.array.can_fs_declare_132);
