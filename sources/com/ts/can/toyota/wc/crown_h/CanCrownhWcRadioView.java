...
public class CanCrownhWcRadioView extends CanRelativeCarInfoView implements View.OnLongClickListener {
    ...
    public CanCrownhWcRadioView(Activity activity) {
        super(activity);
    }
    ...
    private void initCommonScreen() {
        ...
        this.mIvMainFreq.setUserPaint(new CustomImgView.onPaint() {
            public boolean userPaint(CustomImgView view, Canvas canvas, Paint paint) {
                if (!(CanCrownhWcRadioView.this.tunerInfo.UpdateOnce == 0 || CanCrownhWcRadioView.this.tunerInfo.Freq == 0)) {
                    Log.d("RadioMainActivity", "userPaint");
                    int curFreq = CanCrownhWcRadioView.this.tunerInfo.Freq;
                    if (CanCrownhWcRadioView.this.tunerInfo.Band == 1) {
                        if (curFreq > 999) {
                            view.drawImage(CanCrownhWcRadioView.mFreqNum[1], CanCrownhWcRadioView.this.amXStart + (CanCrownhWcRadioView.this.amXdt * 0), CanCrownhWcRadioView.this.yMFNum);
                        }
                        view.drawImage(CanCrownhWcRadioView.mFreqNum[(curFreq % 1000) / 100], CanCrownhWcRadioView.this.amXStart + (CanCrownhWcRadioView.this.amXdt * 1), CanCrownhWcRadioView.this.yMFNum);
                        view.drawImage(CanCrownhWcRadioView.mFreqNum[(curFreq % 100) / 10], CanCrownhWcRadioView.this.amXStart + (CanCrownhWcRadioView.this.amXdt * 2), CanCrownhWcRadioView.this.yMFNum);
                        view.drawImage(CanCrownhWcRadioView.mFreqNum[curFreq % 10], CanCrownhWcRadioView.this.amXStart + (CanCrownhWcRadioView.this.amXdt * 3), CanCrownhWcRadioView.this.yMFNum);
                    } else if (CanCrownhWcRadioView.this.tunerInfo.Band == 2 || CanCrownhWcRadioView.this.tunerInfo.Band == 3 || CanCrownhWcRadioView.this.tunerInfo.Band == 0) {
                        if (curFreq > 9999) {
                            view.drawImage(CanCrownhWcRadioView.mFreqNum[1], CanCrownhWcRadioView.this.ptMFNums[0], CanCrownhWcRadioView.this.yMFNum);
                        }
                        view.drawImage(CanCrownhWcRadioView.mFreqNum[(curFreq % TXZPoiSearchManager.DEFAULT_SEARCH_TIMEOUT) / 1000], CanCrownhWcRadioView.this.ptMFNums[1], CanCrownhWcRadioView.this.yMFNum);
                        view.drawImage(CanCrownhWcRadioView.mFreqNum[(curFreq % 1000) / 100], CanCrownhWcRadioView.this.ptMFNums[2], CanCrownhWcRadioView.this.yMFNum);
                        view.drawImage(R.drawable.can_radio_point_up, CanCrownhWcRadioView.this.xMFDot, CanCrownhWcRadioView.this.yMFDot);
                        view.drawImage(CanCrownhWcRadioView.mFreqNum[(curFreq % 100) / 10], CanCrownhWcRadioView.this.ptMFNums[3], CanCrownhWcRadioView.this.yMFNum);
                        view.drawImage(CanCrownhWcRadioView.mFreqNum[curFreq % 10], CanCrownhWcRadioView.this.ptMFNums[4], CanCrownhWcRadioView.this.yMFNum);
                    }
                }
                return false;
            }
    ...
    public void ResetData(boolean check) {
        ...
        if (!check || i2b(this.tunerInfo.Update)) {
