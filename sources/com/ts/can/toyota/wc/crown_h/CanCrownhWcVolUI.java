...
public class CanCrownhWcVolUI implements UserCallBack {
    public static final String TAG = "CanLexusIs250VolUI";
    protected static Context mContext;
    static CanCrownhWcVolUI mInstance;
    protected static boolean mIsVol;
    private RelativeLayout mLayout;
    private RelativeLayoutManager mManager;
    private CustomImgView mMuteSta;
    private CanDataInfo.CrownWcHeadStatus mVolInfo = new CanDataInfo.CrownWcHeadStatus();
    private int mVolTimeTIck = 0;
    private CustomTextView mVolVal;
    private WindowManager wManager;
    private WindowManager.LayoutParams wmParams = new WindowManager.LayoutParams();

    protected CanCrownhWcVolUI() {
    }

    public static CanCrownhWcVolUI GetInstance() {
        if (mInstance == null) {
            mInstance = new CanCrownhWcVolUI();
        }
        return mInstance;
    }
    ...
    private void ResetData(boolean check) {
        ...
        if (this.mVolTimeTIck == 0) {
            ...
            CanJni.CrownWcGetHeadStatus(this.mVolInfo);
