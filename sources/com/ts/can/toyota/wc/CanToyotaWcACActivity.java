...
public class CanToyotaWcACActivity extends CanBaseActivity implements UserCallBack {
    ...
    private CustomImgView mRearAuto;
    ...
    private ImageView mWindRearDn;
    private ImageView mWindRearPx;
    private ImageView mWindRearUp;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_can_toyota_wc);
    ...
    private void initScreen_768x1024() {
        ...
        this.mWindRearUp = (ImageView) findViewById(R.id.can_ac_rear_wind_up);
        this.mWindRearPx = (ImageView) findViewById(R.id.can_ac_rear_wind_px);
        this.mWindRearDn = (ImageView) findViewById(R.id.can_ac_rear_wind_dn);
        this.mLtTemp = (TextView) findViewById(R.id.can_ac_lttemp);
        this.mRtTemp = (TextView) findViewById(R.id.can_ac_rttemp);
        this.mRearTemp = (TextView) findViewById(R.id.can_ac_rtemp);
        ...
        this.mRearPWR = this.mManger.AddImage(Can.CAN_TOYOTA_SP_XP, 367, 70, 53);
        this.mRearPWR.setStateDrawable(R.drawable.can_rj_gj_up, R.drawable.can_rj_gj_dn);
        this.mRearAuto = this.mManger.AddImage(375, 367, 70, 53);
        this.mRearAuto.setStateDrawable(R.drawable.conditioning_auto01_dn, R.drawable.conditioning_auto_up);
    ...
    private void initCommonScreen() {
        ...
        this.mForePWR.setStateDrawable(R.drawable.can_rj_gj_up, R.drawable.can_rj_gj_dn);
        this.mRearPWR = this.mManger.AddImage(KeyDef.RKEY_POWER_ON, 454);
        this.mRearPWR.setStateDrawable(R.drawable.can_rj_gj_up, R.drawable.can_rj_gj_dn);
        this.mRearAuto = this.mManger.AddImage(450, 454, 89, 65);
        this.mRearAuto.setStateDrawable(R.drawable.conditioning_auto_up, R.drawable.conditioning_auto01_dn);
        for (int i2 = 0; i2 < this.mRearWind.length; i2++) {
    ...
    public void updateACUI() {
        ...
        setIvShow(this.mWindRearUp, this.mACInfo.bRearUpWindFlg);
        setIvShow(this.mWindRearPx, this.mACInfo.bRearParallelWindFlg);
        setIvShow(this.mWindRearDn, this.mACInfo.bRearDownWindFlg);
        ...
        try {
            ...
            this.mRearTemp.setText(this.mACInfo.szRearTemp);
        } catch (Exception e) {
        ...
        this.mRearPWR.SetSel(this.mACInfo.fgRac);
        this.mRearAuto.SetSel(this.mACInfo.nRearAutoLight);
        int rearWind = this.mACInfo.nRearWindValue & 7;
    ...
    public void UserAll() {
        ...
        if (GetTickCount() > CanFunc.mLastACTick + 3000) {
            finish();
            Log.d("CanFordACActivity", "UserAll Exit Ac");
        }
    }
}
