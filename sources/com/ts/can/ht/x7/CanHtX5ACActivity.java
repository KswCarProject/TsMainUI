...
public class CanHtX5ACActivity extends CanBaseActivity implements UserCallBack, View.OnClickListener, CanItemProgressList.onPosChange, View.OnTouchListener {
    ...
    public static final String TAG = "CanHtX5ACActivity";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.mBtnLoop = AddBtn(7, 64, 418, R.drawable.can_mg_car01_up, R.drawable.can_mg_car01_dn);
        this.mBtnForeWind = AddBtn(8, Can.CAN_X80_RZC, 418, R.drawable.can_mg_wind_up, R.drawable.can_mg_wind_dn);
        this.mBtnRearWind = AddBtn(9, 382, 418, R.drawable.can_mg_rear_up, R.drawable.can_mg_rear_dn);
        this.mBtnAcMax = AddBtn(10, CanCameraUI.BTN_NISSAN_XTRAL_RVS_ASSIST2, 418, R.drawable.can_psa_408_acmax_up, R.drawable.can_psa_408_acmax_dn);
        this.mBtnAC = AddBtn(11, CanCameraUI.BTN_CC_WC_DIRECTION1, 418, R.drawable.can_psa_408_ac_up, R.drawable.can_psa_408_ac_dn);
        this.mBtnAuto = AddBtn(12, 859, 418, R.drawable.can_psa_408_auto_up, R.drawable.can_psa_408_auto_dn);
    ...
    public static void ShowAC() {
        if (!mIsAC) {
            mfgJump = true;
            CanFunc.showCanActivity(CanHtX5ACActivity.class);
        }
    }
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        if (action == 0) {
            ...
            switch (Id) {
                case 1:
                    CanJni.HanTRzcAcKey(0, 0, 0, 2);
                    break;
                case 2:
                    CanJni.HanTRzcAcKey(0, 0, 0, 1);
                    break;
                case 3:
                    CanJni.HanTRzcAcKey(128, 0, 0, 0);
                    break;
                case 4:
                    CanJni.HanTRzcAcKey(64, 0, 0, 0);
                    break;
                case 5:
                    CanJni.HanTRzcAcKey(0, 1, 0, 0);
                    break;
                case 6:
                    CanJni.HanTRzcAcKey(0, 2, 0, 0);
                    break;
                case 7:
                    CanJni.HanTRzcAcKey(0, 0, 1, 0);
                    break;
                case 8:
                    CanJni.HanTRzcAcKey(16, 0, 0, 0);
                    break;
                case 9:
                    CanJni.HanTRzcAcKey(0, 4, 0, 0);
                    break;
                case 10:
                    CanJni.HanTRzcAcKey(1, 0, 0, 0);
                    break;
                case 11:
                    CanJni.HanTRzcAcKey(2, 0, 0, 0);
                    break;
                case 12:
                    CanJni.HanTRzcAcKey(32, 0, 0, 0);
                    break;
            }
        } else if (1 == action) {
            Log.d(TAG, "****ACTION_UP*****");
            CanJni.HanTRzcAcKey(0, 0, 0, 0);
        }
        return false;
    }
}
