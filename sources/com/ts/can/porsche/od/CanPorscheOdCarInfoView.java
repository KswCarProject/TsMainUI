...
public class CanPorscheOdCarInfoView extends CanScrollCarInfoView {
    public CanPorscheOdCarInfoView(Activity activity) {
        super(activity, 3);
    }
    ...
    public void InitData() {
        this.mItemTitleIds = new int[]{R.string.can_trip, R.string.can_csshez, R.string.can_tyres_tpms};
