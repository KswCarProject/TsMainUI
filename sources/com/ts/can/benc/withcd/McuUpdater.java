...
/* compiled from: CanBencWithCDUpdateActivity */
class McuUpdater {
    ...
    private CanDataInfo.IapUpdateInfo m_IapData = new CanDataInfo.IapUpdateInfo();
    ...
    public int main() {
        CanJni.BencZmytWithCDGetUpdateInfo(this.m_IapData);
    ...
    public com.ts.can.benc.withcd.McuUpdater.FileInfo getFileData(java.lang.String r9) {
        /*
            r8 = this;
            com.ts.can.benc.withcd.McuUpdater$FileInfo r5 = new com.ts.can.benc.withcd.McuUpdater$FileInfo
            r5.<init>()
            r7 = 0
            r5.len = r7
        ...
        L_0x0080:
            ...
            goto L_0x003f
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ts.can.benc.withcd.McuUpdater.getFileData(java.lang.String):com.ts.can.benc.withcd.McuUpdater$FileInfo");
    }
