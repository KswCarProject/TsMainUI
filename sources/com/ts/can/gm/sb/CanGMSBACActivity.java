...
public class CanGMSBACActivity extends CanBaseActivity implements UserCallBack, View.OnTouchListener {
    ...
    private void updateACUI() {
        ...
        Log.d(CanBaseActivity.TAG, "fgAutoAC =" + this.mACInfo.fgAutoAC);
        Log.d(CanBaseActivity.TAG, "nWindAutoLevel = " + this.mACInfo.nWindAutoLevel);
        Log.d(CanBaseActivity.TAG, "fgAutoWind = " + this.mACInfo.fgAutoWind);
