...
public class CanCadillacXt5UpdateActivity extends Activity {
    public static final String TAG = "CanCadillacXt5UpdateActivity";
    ...
    private View.OnClickListener McuUpdateClick = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            if (id == R.id.xt5_update_start) {
                CanCadillacXt5UpdateActivity.this.mUpdater.startUpdate();
            } else if (id == R.id.xt5_update_reset && CanCadillacXt5UpdateActivity.this.m_IapSta.Sta == 4) {
                Mcu.SendXKey(19);
            }
        }
    };
    ...
    public Runnable runnable = new Runnable() {
        public void run() {
            CanCadillacXt5UpdateActivity.this.onTimer();
            CanCadillacXt5UpdateActivity.handler.postDelayed(CanCadillacXt5UpdateActivity.this.runnable, 30);
        }
    };
