...
public class CanTeanaOldXcCarInfoView extends CanScrollCarInfoView {
    public CanTeanaOldXcCarInfoView(Activity activity) {
        super(activity, 2);
    }
    ...
    public void InitData() {
        this.mItemTitleIds = new int[]{R.string.can_vehi_setup, R.string.can_amp_set};
