...
public class CanTeanaWcVolUI implements UserCallBack {
    public static final String TAG = "CanTeanaWcVolUI";
    protected static Context mContext;
    static CanTeanaWcVolUI mInstance;
    protected static boolean mIsVol;
    private RelativeLayout mLayout;
    private RelativeLayoutManager mManager;
    private CustomImgView mMuteSta;
    private CanDataInfo.TeanaOldWcVolInfo mVolInfo = new CanDataInfo.TeanaOldWcVolInfo();
    private int mVolTimeTIck = 0;
    private CustomTextView mVolVal;
    private WindowManager wManager;
    private WindowManager.LayoutParams wmParams = new WindowManager.LayoutParams();

    protected CanTeanaWcVolUI() {
    }

    public static CanTeanaWcVolUI GetInstance() {
        if (mInstance == null) {
            mInstance = new CanTeanaWcVolUI();
        }
        return mInstance;
    }
    ...
    private void ResetData(boolean check) {
        if (mIsVol) {
            ...
            if (this.mVolTimeTIck == 0) {
                ...
                CanJni.TeanaOldWcReturnVol(this.mVolInfo);
                updateACUI();
            }
        }
    }
