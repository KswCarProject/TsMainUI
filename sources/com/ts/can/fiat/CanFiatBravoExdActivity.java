...
public class CanFiatBravoExdActivity extends CanBaseActivity implements UserCallBack, View.OnClickListener, CanItemProgressList.onPosChange {
    ...
    public static final String TAG = "CanFiatBravoExdActivity";
    ...
    public static void DealDevEvent() {
        ...
        CanJni.FiatBravoGetDevInfo(mDevData);
        ...
        if (fgEnter) {
            if (!mfgThis && CanFunc.IsCamMode() == 0) {
                CanFunc.showCanActivity(CanFiatBravoExdActivity.class);
            }
