...
public class CanMzdRzcCarSetView extends CanScrollCarInfoView {
    public CanMzdRzcCarSetView(Activity activity) {
        super(activity, 7);
    }
    ...
    public void InitData() {
        this.mItemTitleIds = new int[]{R.string.can_mzd_cx4_door, R.string.can_mzd_cx4_turn, R.string.can_mzd_cx4_light, R.string.can_mzd_cx4_drive, R.string.can_mzd_cx4_other, R.string.can_amp_set, R.string.can_mzd_cx4_safe_set};
