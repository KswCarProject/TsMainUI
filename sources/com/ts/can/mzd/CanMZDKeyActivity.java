...
public class CanMZDKeyActivity extends CanBaseActivity implements UserCallBack, View.OnClickListener, View.OnTouchListener {
    public static final int ITEM_CLOCK = 2;
    public static final int ITEM_HOUR = 1;
    public static final int ITEM_MIN = 3;
    public static final String TAG = "CanMZDKeyActivity";
    private int mKey = 0;
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        if (action == 0) {
            ...
            switch (((Integer) v.getTag()).intValue()) {
                case 1:
                    CanJni.MZDSendKey(64);
                    break;
                case 2:
                    CanJni.MZDSendKey(32);
                    break;
                case 3:
                    CanJni.MZDSendKey(128);
                    break;
            }
        } else if (1 == action) {
            CanJni.MZDSendKey(0);
