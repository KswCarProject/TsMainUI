...
public class CanMzdCx4BnrCarSetupView extends CanScrollCarInfoView {
    ...
    public void InitData() {
        this.mItemTitleIds = new int[]{R.string.can_mzd_cx4_door, R.string.can_mzd_cx4_turn, R.string.can_mzd_cx4_light, R.string.can_mzd_cx4_drive, R.string.can_mzd_cx4_safe_set, R.string.can_mzd_cx4_other};
