...
public class CanCheryWcCarInfoView extends CanScrollCarInfoView {
    public CanCheryWcCarInfoView(Activity activity) {
        super(activity, 2);
    }
    ...
    public void InitData() {
        this.mItemTitleIds = new int[]{R.string.can_car_type_select, R.string.can_jsfzxysz};
        this.mItemTypes = new CanScrollCarInfoView.Item[]{CanScrollCarInfoView.Item.CAR_TYPE, CanScrollCarInfoView.Item.TITLE};
        this.mPopValueIds[0] = new int[]{R.array.can_fs_declare_180};
    }
