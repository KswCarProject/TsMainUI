...
public class CanSubuarCarInfoView extends CanScrollCarInfoView {
    public CanSubuarCarInfoView(Activity activity) {
        super(activity, 3);
    }
    ...
    public void InitData() {
        this.mItemTitleIds = new int[]{R.string.can_bcfz, R.string.can_car_set, R.string.can_amp_set};
