...
public class CanXbsygCarTypeActivity extends CanBaseActivity implements View.OnClickListener, UserCallBack, CanItemPopupList.onPopItemClick {
    private static final int ITEM_MAX = 1;
    private static final int ITEM_MIN = 1;
    public static final int ITEM_TYPE = 1;
    public static final String TAG = "CanRZygCarTypeActivity";
    private static final int[] mTypeArr = {R.string.can_car_16zyg_dp, R.string.can_car_16zyg_gp, R.string.can_car_16zyx, R.string.can_car_17znz};
    ...
    public void onResume() {
        ...
        ResetData(false);
        QueryData();
        Log.d("CanRZygCarTypeActivity", "subtype = " + CanJni.GetSubType());
    ...
    public void onItem(int id, int item) {
        if (id == 1) {
            Log.d("CanRZygCarTypeActivity", "Select = " + item);
