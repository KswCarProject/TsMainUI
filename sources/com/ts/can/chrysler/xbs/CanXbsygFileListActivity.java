...
public class CanXbsygFileListActivity extends CanBaseActivity implements View.OnClickListener, UserCallBack {
    ...
    public void onCreate(Bundle arg0) {
        ...
        this.mLvFile.setOnScrollListener(new AbsListView.OnScrollListener() {
            ...
            public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
                CanXbsygFileListActivity.this.mCurTopIndex = firstVisibleItem;
    ...
    private class FileListAdapter extends BaseAdapter implements View.OnClickListener {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (CanJni.ChrOthGetList(position, CanXbsygFileListActivity.this.mListItemData) != 0) {
                holder.mFileItem.SetVal(String.format("%d、 %s", new Object[]{Integer.valueOf(position + 1), CanIF.byte2UnicodeStr(CanXbsygFileListActivity.this.mListItemData.szData)}));
            } else {
                holder.mFileItem.SetVal(String.valueOf(position + 1) + "、 Track " + (position + 1));
            }
            return convertView;
        ...
        public void onClick(View v) {
            ...
            CanJni.ChrOthCDCtrl(16, (index >> 8) & 255, index & 255);
        }
    }
}
