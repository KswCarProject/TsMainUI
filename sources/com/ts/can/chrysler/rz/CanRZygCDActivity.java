...
public class CanRZygCDActivity extends CanBaseActivity implements UserCallBack, View.OnClickListener, CanItemProgressList.onPosChange {
    ...
    public static final String TAG = "CanRZygCDActivity";
    ...
    private void initScreen_768x1024() {
        ...
        this.mBtnList = AddBtn(9, 639, 23, 103, 56, R.drawable.can_jeep_ycsb_list_up, R.drawable.can_jeep_ycsb_list_dn);
        this.mManager.AddImageEx(23, 93, 30, 30, R.drawable.can_jeep_ycsb_sjx);
        this.mSta = AddTxtLt(79, 85, 300, 36);
        this.mManager.AddImage(26, Can.CAN_CC_WC, R.drawable.can_jeep_ycsb_music);
        this.mManager.AddImage(26, 212, R.drawable.can_jeep_ycsb_disc);
        this.mManager.AddImage(26, 269, R.drawable.can_jeep_ycsb_artist);
        this.mSong = AddTxtLt(66, 151, 300, 36);
        this.mArtist = AddTxtLt(66, 209, 300, 36);
        this.mAlbum = AddTxtLt(66, 266, 300, 36);
    ...
    public void onClick(View v) {
        switch (((Integer) v.getTag()).intValue()) {
            ...
            case 8:
                ...
                return;
            case 9:
                enterSubWin(CanRZygFileListActivity.class);
                return;
            default:
                return;
        }
