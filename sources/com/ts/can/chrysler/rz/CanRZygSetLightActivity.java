...
public class CanRZygSetLightActivity extends CanRZygBaseActivity implements View.OnClickListener, UserCallBack, CanItemPopupList.onPopItemClick {
    ...
    public static final int ITEM_SDZXDD = 12;
    ...
    public void InitUI() {
        ...
        this.mItemSdzxdd = AddCheckItem(R.string.can_sdzxdd, 12);
    }
    ...
    public void onClick(View v) {
        switch (((Integer) v.getTag()).intValue()) {
            case 2:
                CarSWSet(21, this.mSetData.FlashLights);
                return;
            case 4:
                CarSWSet(20, this.mSetData.DaytimeLights);
                return;
            case 5:
                CarSWSet(22, this.mSetData.Zdfxygd);
                return;
            case 6:
                CarSWSet(19, this.mSetData.Qdygzdqddd);
                return;
            case 7:
                CarSWSet(144, this.mSetData.Ybd);
                return;
            case 8:
                CarSWSet(145, this.mSetData.Zxd);
                return;
            case 11:
                CarSet(149, Neg(this.mSetData.Zjfzd) + 1);
                return;
            case 12:
                CarSet(135, Neg(this.mSetData.Sdzxdd) + 1);
                return;
            default:
                return;
        }
