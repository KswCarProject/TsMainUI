...
public class CanRZygCarTypeActivity extends CanBaseActivity implements View.OnClickListener, UserCallBack, CanItemPopupList.onPopItemClick {
    ...
    public void InitUI() {
        ...
        this.mTypeArr = getResources().getStringArray(R.array.can_fs_declare_38);
