...
public class CanChrOthSetCompassActivity extends CanChrOthBaseActivity implements View.OnClickListener, UserCallBack, CanItemProgressList.onPosChange {
    public static final int ITEM_LPCZ = 2;
    public static final int ITEM_LPFX = 1;
    public static final int ITEM_LPJZ = 3;
    private static final int ITEM_MAX = 3;
    private static final int ITEM_MIN = 1;
    public static final String TAG = "CanChrOthSetCompassActivity";
    ...
    public void ResetData(boolean check) {
        ...
        if (!check || i2b(this.mSetData.CompassUpdate)) {
            ...
            if (this.mSetData.CpsShowSta == 0) {
                this.mItemLpjz.SetVal(R.string.can_fjz);
            } else {
                this.mItemLpjz.SetVal(R.string.can_zzjz);
            }
        }
    }
    ...
    public void InitUI() {
        ...
        this.mItemLpcz.SetMinMax(1, 16);
        this.mItemLpcz.SetIdCallBack(2, this);
        this.mItemLpcz.GetBtnSub().Show(false);
        this.mItemLpcz.GetProgress().Show(false);
