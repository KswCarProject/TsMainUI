...
public class CanMGCarTypeActivity extends CanBaseActivity implements View.OnClickListener, UserCallBack, CanItemPopupList.onPopItemClick {
    private static final int ITEM_MAX = 1;
    private static final int ITEM_MIN = 1;
    public static final int ITEM_TYPE = 1;
    public static final String TAG = "CanMGCarTypeActivity";
    ...
    public void onCreate(Bundle arg0) {
        super.onCreate(arg0);
        this.mTypeArr = getResources().getStringArray(R.array.can_fs_declare_26);
