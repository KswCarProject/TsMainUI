...
public class CanMGGSFindLightActivity extends CanMGGSBaseActivity implements View.OnClickListener, UserCallBack, CanItemPopupList.onPopItemClick {
    ...
    public static final String TAG = "CanMGGSFindLightActivity";
    ...
    public void ResetData(boolean check) {
        ...
        if (!check || i2b(this.mSetData.Update)) {
            ...
            this.mItemRevLight.SetCheck(this.mSetData.fgFindRevLight);
            this.mItemNearLight.SetCheck(this.mSetData.fgFindNearLigh);
            this.mItemRFogLight.SetCheck(this.mSetData.fgFindRearLight);
            this.mItemDuration.SetSel(this.mSetData.FindTime);
        }
    }
    ...
    public void InitUI() {
        ...
        this.mManager.AddView(new CanItemBlankTextList((Context) this, R.string.can_xcd).GetView());
    ...
    public void onClick(View v) {
        switch (((Integer) v.getTag()).intValue()) {
            case 1:
                CarSet(2, 3, GetLightVal(Neg(this.mSetData.fgFindRevLight), this.mSetData.fgFindNearLigh, this.mSetData.fgFindRearLight));
                return;
            case 2:
                CarSet(2, 3, GetLightVal(this.mSetData.fgFindRevLight, Neg(this.mSetData.fgFindNearLigh), this.mSetData.fgFindRearLight));
                return;
            case 3:
                CarSet(2, 3, GetLightVal(this.mSetData.fgFindRevLight, this.mSetData.fgFindNearLigh, Neg(this.mSetData.fgFindRearLight)));
                return;
            default:
                return;
        }
