...
public class CanSaicRWMGWcCarInfoView extends CanScrollCarInfoView {
    public CanSaicRWMGWcCarInfoView(Activity activity) {
        super(activity, 5);
    }
    ...
    public void InitData() {
        this.mItemTitleIds = new int[]{R.string.can_car_type_select, R.string.can_jsfzxysz, R.string.can_light_setup, R.string.can_ac_set, R.string.can_system_set};
        ...
        this.mPopValueIds[0] = new int[]{R.array.can_fs_declare_177};
    }
