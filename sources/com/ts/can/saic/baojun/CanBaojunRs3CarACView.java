...
public class CanBaojunRs3CarACView extends CanBaseACView {
    ...
    public CanBaojunRs3CarACView(Activity activity) {
        super(activity);
    }
    ...
    public void ACSet(int Id, int para) {
        switch (Id) {
            case 2:
                CanJni.BaojunRzcAirSet(1, para);
                return;
            case 3:
                CanJni.BaojunRzcAirSet(21, para);
                return;
            case 6:
                CanJni.BaojunRzcAirSet(23, para);
                return;
            case 7:
                CanJni.BaojunRzcAirSet(13, para);
                return;
            case 8:
                CanJni.BaojunRzcAirSet(14, para);
                return;
            case 9:
                CanJni.BaojunRzcAirSet(7, para);
                return;
            case 10:
                CanJni.BaojunRzcAirSet(8, para);
                return;
            case 11:
                CanJni.BaojunRzcAirSet(9, para);
                return;
            case 12:
                CanJni.BaojunRzcAirSet(10, para);
                return;
            case 13:
                CanJni.BaojunRzcAirSet(15, para);
                return;
            case 14:
                CanJni.BaojunRzcAirSet(16, para);
                return;
            case 17:
                CanJni.BaojunRzcAirSet(0, para);
                return;
            case 18:
                CanJni.BaojunRzcAirSet(12, para);
                return;
            case 19:
                CanJni.BaojunRzcAirSet(11, para);
                return;
            case 25:
                CanJni.BaojunRzcAirSet(6, para);
                return;
            default:
                return;
        }
    ...
    public void updateACUI() {
        ...
        ParamButton paramButton6 = this.mBtnOff;
        if (this.mACInfo.nWindValue > 0) {
            i = 0;
        }
        paramButton6.SetSel(i);
