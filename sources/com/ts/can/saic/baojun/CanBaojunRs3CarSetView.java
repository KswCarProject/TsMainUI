...
public class CanBaojunRs3CarSetView extends CanScrollCarInfoView {
    public CanBaojunRs3CarSetView(Activity activity) {
        super(activity, 4);
    }
    ...
    public void InitData() {
        this.mItemTitleIds = new int[]{R.string.can_scene_mode, R.string.can_light_setup, R.string.can_car_lock_set, R.string.can_other_set};
