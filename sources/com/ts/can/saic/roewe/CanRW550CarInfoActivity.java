...
public class CanRW550CarInfoActivity extends CanBaseActivity implements View.OnClickListener, UserCallBack, CanItemPopupList.onPopItemClick {
    private static final int ITEM_MAX = 2;
    private static final int ITEM_MIN = 1;
    public static final int ITEM_SCR_COLOR = 1;
    public static final int ITEM_TYPE = 2;
    public static final String TAG = "CanRW550CarInfoActivity";
    private static final int[] mTypeArr = {R.string.can_roewe_key1, R.string.can_roewe_key2};
