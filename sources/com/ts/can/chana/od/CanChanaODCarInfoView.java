...
public class CanChanaODCarInfoView extends CanScrollCarInfoView {
    public CanChanaODCarInfoView(Activity activity) {
        super(activity, 4);
    }
    ...
    public void InitData() {
        this.mItemTitleIds = new int[]{R.string.can_car_type_select, R.string.can_ac_set, R.string.can_vehi_setup, R.string.can_csxx};
        ...
        this.mPopValueIds[0] = new int[]{R.array.can_fs_declare_269};
    }
