...
public class CanCs75WcCarInfoActivity extends CanScrollCarInfoView {
    public CanCs75WcCarInfoActivity(Activity activity) {
        super(activity, 2);
    }
    ...
    public void InitData() {
        this.mItemTitleIds = new int[]{R.string.can_car_info, R.string.can_car_set};
