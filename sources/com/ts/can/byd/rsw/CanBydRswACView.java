...
public class CanBydRswACView extends CanBaseACView {
    ...
    public CanBydRswACView(Activity activity) {
        super(activity);
    }
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        if (action != 0) {
            if (1 == action) {
                switch (Id) {
                    case 1:
                        CanJni.BydRswAirKey(15, 0);
                        break;
                    case 2:
                        CanJni.BydRswAirKey(13, 0);
                        break;
                    case 3:
                        CanJni.BydRswAirKey(10, 0);
                        break;
                    case 4:
                        CanJni.BydRswAirKey(8, 0);
                        break;
                    case 5:
                        CanJni.BydRswAirKey(11, 0);
                        break;
                    case 6:
                        CanJni.BydRswAirKey(12, 0);
                        break;
                    case 7:
                        CanJni.BydRswAirKey(4, 0);
                        break;
                    case 8:
                        CanJni.BydRswAirKey(5, 0);
                        break;
                    case 9:
                        CanJni.BydRswAirKey(34, 0);
                        break;
                    case 10:
                        CanJni.BydRswAirKey(34, 0);
                        break;
                    ...
                    case 12:
                        ...
                        break;
                    case 13:
                        CanJni.BydRswAirKey(6, 0);
                        break;
                    case 14:
                        CanJni.BydRswAirKey(7, 0);
                        break;
                    case 17:
                        CanJni.BydRswAirKey(1, 0);
                        break;
                    case 18:
                        CanJni.BydRswAirKey(3, 0);
                        break;
                    case 19:
                        CanJni.BydRswAirKey(2, 0);
                        break;
                    case 20:
                        CanJni.BydRswAirKey(9, 0);
                        break;
                    case 22:
                        CanJni.BydRswAirKey(14, 0);
                        break;
                    case 25:
                        CanJni.BydRswAirKey(16, 0);
                        break;
                }
            }
        } else {
            switch (Id) {
                case 1:
                    CanJni.BydRswAirKey(15, 1);
                    break;
                case 2:
                    CanJni.BydRswAirKey(13, 1);
                    break;
                case 3:
                    CanJni.BydRswAirKey(10, 1);
                    break;
                case 4:
                    CanJni.BydRswAirKey(8, 1);
                    break;
                case 5:
                    CanJni.BydRswAirKey(11, 1);
                    break;
                case 6:
                    CanJni.BydRswAirKey(12, 1);
                    break;
                case 7:
                    CanJni.BydRswAirKey(4, 1);
                    break;
                case 8:
                    CanJni.BydRswAirKey(5, 1);
                    break;
                case 9:
                    CanJni.BydRswAirKey(34, 1);
                    break;
                case 10:
                    CanJni.BydRswAirKey(34, 2);
                    break;
                case 11:
                    CanJni.BydRswAirKey(34, 3);
                    break;
                case 12:
                    CanJni.BydRswAirKey(34, 4);
                    break;
                case 13:
                    CanJni.BydRswAirKey(6, 1);
                    break;
                case 14:
                    CanJni.BydRswAirKey(7, 1);
                    break;
                case 17:
                    CanJni.BydRswAirKey(1, 1);
                    break;
                case 18:
                    CanJni.BydRswAirKey(3, 1);
                    break;
                case 19:
                    CanJni.BydRswAirKey(2, 1);
                    break;
                case 20:
                    CanJni.BydRswAirKey(9, 1);
                    break;
                case 22:
                    CanJni.BydRswAirKey(14, 1);
                    break;
                case 25:
                    CanJni.BydRswAirKey(16, 1);
                    break;
            }
        }
        return false;
    ...
    private void initCommonScreen() {
        ...
        this.mBtnAcMax = AddBtn(1, 352, 302, 150, 64, R.drawable.can_jeep_ac_kong_up, R.drawable.can_jeep_ac_kong_dn, R.string.can_air_acmax);
        this.mBtnTf = AddBtn(25, 512, 302, 150, 64, R.drawable.can_jeep_ac_kong_up, R.drawable.can_jeep_ac_kong_dn, R.string.can_air_tf);
        ...
        this.mBtnWdPx = AddBtn(9, Can.CAN_SITECHDEV_CW, 164, R.drawable.can_jeep_ac_01_up, R.drawable.can_jeep_ac_01_dn);
    ...
    public void updateACUI() {
        ...
        this.mBtnTf.SetSel(this.mACInfo.fgEco);
