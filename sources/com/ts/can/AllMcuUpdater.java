...
class AllMcuUpdater {
    ...
    private static AllMcuUpdater mInstance;
    ...
    private CanDataInfo.IapUpdateData m_IapData = new CanDataInfo.IapUpdateData();
    ...
    public static AllMcuUpdater getInstance() {
        if (mInstance == null) {
            mInstance = new AllMcuUpdater();
        }
        return mInstance;
    }

    private AllMcuUpdater() {
    }
    ...
    public int main() {
        CanJni.CanGetIapData(this.m_IapData);
    ...
    public com.ts.can.AllMcuUpdater.FileInfo getFileData(java.lang.String r9) {
        /*
            r8 = this;
            com.ts.can.AllMcuUpdater$FileInfo r5 = new com.ts.can.AllMcuUpdater$FileInfo
            r5.<init>()
            r7 = 0
            r5.len = r7
        ...
        L_0x0080:
            ...
            goto L_0x003f
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ts.can.AllMcuUpdater.getFileData(java.lang.String):com.ts.can.AllMcuUpdater$FileInfo");
    }
