...
public class CanPSARzcAcView extends CanBaseACView {
    ...
    public static final int ITEM_REAR = 18;
    ...
    public static final String TAG = "CanPSARzcAcView";
    ...
    public CanPSARzcAcView(Activity activity) {
        super(activity);
    }
    ...
    public void onClick(View v) {
        switch (((Integer) v.getTag()).intValue()) {
            ...
            case 17:
                ...
                return;
            case 18:
                CanJni.PSAACSet(15, Neg(this.mACInfo.fgRac));
                return;
            default:
                return;
        }
    ...
    private void initCommonScreen() {
        ...
        this.mBtnRear = AddBtn(18, 880, 192, 117, 62, R.drawable.can_psa_kong_up, R.drawable.can_psa_kong_dn);
        this.mBtnRear.setText("REAR");
        this.mBtnRear.setTextSize(20.0f);
        this.mBtnRear.setTextColor(-1);
        if (!this.isJumped) {
    ...
    public void updateACUI() {
        ...
        this.mBtnRear.SetSel(this.mACInfo.fgRac);
    }
