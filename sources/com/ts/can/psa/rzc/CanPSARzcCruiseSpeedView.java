...
public class CanPSARzcCruiseSpeedView extends CanRelativeCarInfoView implements CanNumInuptDlg.onInputOK {
    public static final int ITEM_OK = 11;
    public static final int ITEM_RESET = 10;
    public static final int ITEM_VAL_BASE = 1;
    public static final String TAG = "CanPSACruiseSpeedActivity";
    private ParamButton[] mBtnSpeed;
    private RelativeLayoutManager mManager;
    protected CanDataInfo.PeugMemTab mSpeedData;
    protected boolean mbModify;

    public CanPSARzcCruiseSpeedView(Activity activity) {
        super(activity);
    }
    ...
    public void InitUI() {
        ...
        this.mSpeedData = new CanDataInfo.PeugMemTab();
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            case 10:
                this.mbModify = false;
                CanJni.PSACruiseSpeedSet(this.mSpeedData, 1);
                return;
            case 11:
                this.mbModify = false;
                CanJni.PSACruiseSpeedSet(this.mSpeedData, 0);
                return;
            default:
                if (id >= 1 && id <= 6) {
    ...
    public void ResetData(boolean check) {
        if (!this.mbModify) {
            CanJni.PSAGetCruiseSpeed(this.mSpeedData);
