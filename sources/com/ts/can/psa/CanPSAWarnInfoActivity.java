...
public class CanPSAWarnInfoActivity extends CanPSABaseActivity implements View.OnClickListener, UserCallBack {
    ...
    private CanDataInfo.PeugWarnInfo mWarnData = new CanDataInfo.PeugWarnInfo();
    ...
    public void InitUI() {
        ...
        this.mWarnArr = getResources().getStringArray(R.array.can_psa_warn);
