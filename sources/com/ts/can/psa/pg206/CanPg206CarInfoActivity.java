...
public class CanPg206CarInfoActivity extends CanBaseActivity implements View.OnClickListener, UserCallBack {
    ...
    public static final String TAG = "CanPg206CarInfoActivity";
    ...
    public void ResetData(boolean check) {
        ...
        if (i2b(this.mYslc.UpdateOnce) && (!check || i2b(this.mYslc.Update))) {
            this.mYslc.Update = 0;
            if (this.mYslc.uwLC > 9999) {
                this.mItemYslc.SetVal(String.format("--", new Object[0]));
            } else {
        ...
        if (i2b(this.mPjcs.UpdateOnce) && (!check || i2b(this.mPjcs.Update))) {
            this.mPjcs.Update = 0;
        ...
        CanJni.Pg2xGetSscsData(this.mSscs);
        if (!i2b(this.mSscs.UpdateOnce)) {
            return;
        }
        if (!check || i2b(this.mSscs.Update)) {
            this.mSscs.Update = 0;
            this.mItemSscs.SetVal(String.format("%d Km/h", new Object[]{Integer.valueOf(this.mSscs.uwSpeed)}));
        }
    }
    ...
    public void InitUI() {
        ...
        this.mItemSscs = AddItemTitleVal(R.string.can_curspeed, 6);
    }
