...
public class CanBZCarTypeActivity extends CanBZBaseActivity implements View.OnClickListener, UserCallBack, CanItemPopupList.onPopItemClick {
    private static final int ITEM_MAX = 1;
    private static final int ITEM_MIN = 1;
    public static final int ITEM_TYPE = 1;
    public static final String TAG = "CanBZCarTypeActivity";
    private static final int[] mTypeArr = {R.string.can_psa_301other, R.string.can_car_null, R.string.can_car_null, R.string.can_car_null, R.string.can_psa_c4l};
