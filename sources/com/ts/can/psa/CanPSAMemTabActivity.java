...
public class CanPSAMemTabActivity extends CanBaseActivity implements UserCallBack, View.OnClickListener, CanItemProgressList.onPosChange, CanNumInuptDlg.onInputOK {
    ...
    public static final String TAG = "CanPSAMemTabActivity";
    ...
    private void ResetData(boolean check) {
        if (!this.mbModify) {
            CanJni.PSAGetMemTab(this.mSpeedData);
    ...
    private void SetChk(int index, int chk) {
        ParamButton btn;
        Log.d("CanPSAMemTabActivity", "SetChk index = " + index + ", chk = " + chk);
        if (5 == index) {
            btn = this.mBtnTopChk;
        } else {
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            case 10:
                this.mbModify = false;
                CanJni.PSAMemTabSet(this.mSpeedData, 1);
                return;
            case 11:
                this.mbModify = false;
                CanJni.PSAMemTabSet(this.mSpeedData, 0);
                return;
            case 12:
