...
public class CanLexusZMYTUpdateView extends CanRelativeCarInfoView {
    ...
    private View.OnClickListener McuUpdateClick = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            if (id == R.id.mcu_update_start) {
                CanLexusZMYTUpdateView.this.mUpdater.startUpdate();
            } else if (id == R.id.mcu_update_reset && CanLexusZMYTUpdateView.this.mUpdater.getIapSta() == 65535) {
                Mcu.SendXKey(19);
            }
        }
    };
    ...
    public Runnable runnable = new Runnable() {
        public void run() {
            CanLexusZMYTUpdateView.this.onTimer();
            CanLexusZMYTUpdateView.handler.postDelayed(CanLexusZMYTUpdateView.this.runnable, 30);
        }
    };

    public CanLexusZMYTUpdateView(Activity activity) {
        super(activity);
    }
    ...
    private void initScreen() {
        ...
        this.mReset.setOnClickListener(new View.OnClickListener() {
            public void onClick(View arg0) {
                if (CanLexusZMYTUpdateView.this.mUpdater.getIapSta() == 65535) {
                    Mcu.SendXKey(19);
                }
            }
        });
