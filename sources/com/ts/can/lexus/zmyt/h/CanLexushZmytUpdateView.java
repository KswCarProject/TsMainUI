...
public class CanLexushZmytUpdateView extends CanRelativeCarInfoView {
    public static final String TAG = "CanLexusZMYTUpdateView";
    ...
    private View.OnClickListener McuUpdateClick = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            if (id == R.id.mcu_update_start) {
                CanLexushZmytUpdateView.this.mUpdater.startUpdate();
            } else if (id == R.id.mcu_update_reset && CanLexushZmytUpdateView.this.mUpdater.getIapSta() == 65535) {
                Mcu.SendXKey(19);
            }
        }
    };
    ...
    public Runnable runnable = new Runnable() {
        public void run() {
            CanLexushZmytUpdateView.this.onTimer();
            CanLexushZmytUpdateView.handler.postDelayed(CanLexushZmytUpdateView.this.runnable, 30);
        }
    };

    public CanLexushZmytUpdateView(Activity activity) {
        super(activity);
    }
    ...
    public void doOnPause() {
        ...
        if (!this.mUpdater.IsUpdating()) {
            ...
            Log.d("CanLexusZMYTUpdateView", "onPause !mUpdater.IsUpdating, removeCallbacks");
        }
    }
    ...
    private void initScreen() {
        ...
        this.mReset.setOnClickListener(new View.OnClickListener() {
            public void onClick(View arg0) {
                if (CanLexushZmytUpdateView.this.mUpdater.getIapSta() == 65535) {
                    Mcu.SendXKey(19);
                }
            }
        });
