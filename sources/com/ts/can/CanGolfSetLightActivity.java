...
public class CanGolfSetLightActivity extends CanGolfBaseActivity implements View.OnClickListener, CanItemProgressList.onPosChange, CanItemPopupList.onPopItemClick, UserCallBack {
    ...
    private CanDataInfo.GolfAdtLight mAdtLight1 = new CanDataInfo.GolfAdtLight();
    private CanDataInfo.GolfAdtLight2 mAdtLight2 = new CanDataInfo.GolfAdtLight2();
    private CanDataInfo.GolfBackgroundLighting mBgLightData = new CanDataInfo.GolfBackgroundLighting();
    ...
    private CanDataInfo.GolfLight mLight1Data = new CanDataInfo.GolfLight();
    private CanDataInfo.GolfLight2 mLight2Data = new CanDataInfo.GolfLight2();
    ...
    public void ResetData(boolean check) {
        ...
        if (!check || i2b(this.mLight1Data.Update)) {
            ...
            if (this.mLight1Data.ComingHomeFunc == 0) {
                ...
                this.mItemCommingFunc.SetValText(String.valueOf(this.mLight1Data.ComingHomeFunc) + "s");
            }
            ...
            if (this.mLight1Data.LeavingHomeFunc == 0) {
                ...
                this.mItemLeavingFunc.SetValText(String.valueOf(this.mLight1Data.LeavingHomeFunc) + "s");
            }
        }
        if (!check || i2b(this.mLight2Data.Update)) {
            ...
            this.mItemDoorLight.SetValText(String.valueOf(this.mLight2Data.DoorAmbientLight) + "%");
            this.mItemFootwellLight.SetCurVal(this.mLight2Data.FootwellLight);
            this.mItemFootwellLight.SetValText(String.valueOf(this.mLight2Data.FootwellLight) + "%");
        ...
        if (!check || i2b(this.mBgLightData.Update)) {
            ...
            this.mItemTopLight.SetValText(String.valueOf(this.mBgLightData.Cdkjzmd) + "%");
            this.mItemForeLight.SetCurVal(this.mBgLightData.Qbkjzmd);
            this.mItemForeLight.SetValText(String.valueOf(this.mBgLightData.Qbkjzmd) + "%");
            this.mItemAllLight.SetCurVal(this.mBgLightData.Syqyzm);
            this.mItemAllLight.SetValText(String.valueOf(this.mBgLightData.Syqyzm) + "%");
