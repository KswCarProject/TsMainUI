...
public class CanLandWindOdCarInfoView extends CanScrollCarInfoView {
    public CanLandWindOdCarInfoView(Activity activity) {
        super(activity, 2);
    }
    ...
    public void InitData() {
        this.mItemTitleIds = new int[]{R.string.can_car_set, R.string.can_tyres_tpms};
