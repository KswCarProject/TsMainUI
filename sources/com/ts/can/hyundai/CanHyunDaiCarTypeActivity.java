...
public class CanHyunDaiCarTypeActivity extends CanBaseActivity implements View.OnClickListener, UserCallBack, CanItemPopupList.onPopItemClick {
    private static final int ITEM_MAX = 1;
    private static final int ITEM_MIN = 1;
    public static final int ITEM_TYPE = 1;
    public static final String TAG = "CanHyunDaiCarTypeActivity";
    ...
    public void InitUI() {
        ...
        this.mTypeArr = getResources().getStringArray(R.array.can_fs_declare_14);
