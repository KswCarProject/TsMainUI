...
public class CanAccord8XbsVolUI implements UserCallBack {
    public static final String TAG = "CanAccord8VolUI";
    protected static Context mContext;
    static CanAccord8XbsVolUI mInstance;
    ...
    protected CanAccord8XbsVolUI() {
    }

    public static CanAccord8XbsVolUI GetInstance() {
        if (mInstance == null) {
            mInstance = new CanAccord8XbsVolUI();
        }
        return mInstance;
    }
