...
public class CanHondaDaRzcAcView extends CanBaseACView {
    ...
    public CanHondaDaRzcAcView(Activity activity) {
        super(activity);
    }
    ...
    private void initScreen_768x432() {
        setBackgroundResource(R.drawable.can_syac_sp_bg);
        this.mLtTemp = addText(28, 25, 95, 59);
        this.mLtTemp.setTextSize(0, 32.0f);
        this.mLtTemp.setTextColor(-1);
        this.mLtTemp.setText("13℃");
        this.mLtTemp.setGravity(17);
        this.mRtTemp = addText(CanCameraUI.BTN_LANDWIND_2D_RIGHT, 25, 95, 59);
    ...
    private void initScreen_1280x480() {
        setBackgroundResource(R.drawable.can_syac_hp_bg);
        this.mLtTemp = addText(57, 2, 131, 59);
        this.mLtTemp.setTextSize(0, 40.0f);
        this.mLtTemp.setTextColor(-1);
        this.mLtTemp.setText("13℃");
        this.mLtTemp.setGravity(17);
        this.mRtTemp = addText(1093, 2, 131, 59);
    ...
    private ParamButton AddBtn(int x, int y, int w, int h, int id) {
        ParamButton btn = addButton(x, y, w, h);
        btn.setOnTouchListener(this);
        btn.setTag(Integer.valueOf(id));
        return btn;
    }
