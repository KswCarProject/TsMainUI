...
public class CanHondaWcUsbIpodView extends CanRelativeCarInfoView {
    ...
    public static final String TAG = "CanHondaWcUSBIPODView";
    ...
    /* access modifiers changed from: private */
    public CanDataInfo.HondaWcMedia mMediaData;
    ...
    public CanHondaWcUsbIpodView(Activity activity) {
        super(activity);
    }
    ...
    private void initCommonScreen() {
        this.mMediaData = new CanDataInfo.HondaWcMedia();
        ...
        this.mProgress.setUserPaint(new CustomImgView.onPaint() {
            public boolean userPaint(CustomImgView view, Canvas canvas, Paint paint) {
                int pos = CanHondaWcUsbIpodView.this.mMediaData.PlayPro;
                ...
                if (pos > 0 && pos <= 100) {
                    ...
                    des.right = w + 12;
                    des.bottom = 25;
                    canvas.drawBitmap(CanHondaWcUsbIpodView.this.mBmpProgDn, src, des, paint);
                }
                return false;
            }
        });
    ...
    public void ResetData(boolean check) {
        CanJni.HondaWcGetMediaInfo(this.mMediaData);
    ...
    public void CdCtrl(int cmd, int part1) {
        CanJni.HondaWcCarMediaCmd(cmd, part1);
    }
