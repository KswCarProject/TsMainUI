...
public class CanCrownWcVolUI implements UserCallBack {
    public static final String TAG = "CanLexusIs250VolUI";
    protected static Context mContext;
    static CanCrownWcVolUI mInstance;
    ...
    protected CanCrownWcVolUI() {
    }

    public static CanCrownWcVolUI GetInstance() {
        if (mInstance == null) {
            mInstance = new CanCrownWcVolUI();
        }
        return mInstance;
    }
