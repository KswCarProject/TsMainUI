...
public class CanAccordXbsRadioActivity extends CanBaseActivity implements UserCallBack, View.OnClickListener, View.OnLongClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.mImgMainFreq.setUserPaint(new CustomImgView.onPaint() {
            public boolean userPaint(CustomImgView view, Canvas canvas, Paint paint) {
                if (!(CanAccordXbsRadioActivity.this.mCurFreqData.UpdateOnce == 0 || CanAccordXbsRadioActivity.this.mCurFreqData.CurFreq == 0)) {
                    int Bai = (CanAccordXbsRadioActivity.this.mCurFreqData.CurFreq / 100) % 10;
                    int Shi = (CanAccordXbsRadioActivity.this.mCurFreqData.CurFreq / 10) % 10;
                    int Ge = CanAccordXbsRadioActivity.this.mCurFreqData.CurFreq % 10;
                    if (CanAccordXbsRadioActivity.this.mCurFreqData.Band != 0) {
                        if (CanAccordXbsRadioActivity.this.mCurFreqData.CurFreq >= 1000) {
                            view.drawImage(CanAccordXbsRadioActivity.mFreqNumArr[1], 396, 0);
                        }
                        view.drawImage(CanAccordXbsRadioActivity.mFreqNumArr[Bai], 444, 0);
                        view.drawImage(CanAccordXbsRadioActivity.mFreqNumArr[Shi], 492, 0);
                        view.drawImage(CanAccordXbsRadioActivity.mFreqNumArr[Ge], CanCameraUI.BTN_NISSAN_XTRAL_RVS_ASSIST1, 0);
                    } else {
                        if (CanAccordXbsRadioActivity.this.mCurFreqData.CurFreq >= 1000) {
                            view.drawImage(CanAccordXbsRadioActivity.mFreqNumArr[1], 386, 0);
                        }
                        view.drawImage(CanAccordXbsRadioActivity.mFreqNumArr[Bai], 434, 0);
                        view.drawImage(CanAccordXbsRadioActivity.mFreqNumArr[Shi], 482, 0);
                        view.drawImage(CanAccordXbsRadioActivity.mFreqNumArr[Ge], 551, 0);
    ...
    public void AccordRadioCtrl(int cmd, int para) {
        CanJni.Yg9XbsRadioCtrl(cmd, para);
    }
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            ...
            case 4:
                ...
                return;
            case 5:
                AccordRadioCtrl(81, 0);
                return;
            case 6:
                AccordRadioCtrl(81, 1);
                return;
            case 7:
                ShowPage(1);
                return;
            case 8:
                ...
                return;
            case 9:
                AccordRadioCtrl(10, 1);
                return;
            case 10:
                AccordRadioCtrl(12, 1);
                return;
            default:
                if (id >= 16 && id <= 28) {
                    AccordRadioCtrl(6, (id - 16) + 1);
                    return;
                } else if (id >= 32 && id <= 62) {
                    AccordRadioCtrl(11, (id - 32) + 1);
                    ShowPage(0);
                    return;
                } else {
                    return;
