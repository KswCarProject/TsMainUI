package com.ts.can.honda.cyt.accord7;
...
public class CanAccord7CYTACView extends CanBaseACView {
    ...
    public CanAccord7CYTACView(Activity activity) {
        super(activity);
    }
    ...
    private void SendKey(int id) {
        switch (id) {
            case 0:
                CanJni.HondaAccord7CytAirKey(9);
                return;
            case 1:
                CanJni.HondaAccord7CytAirKey(10);
                return;
            case 2:
                CanJni.HondaAccord7CytAirKey(20);
                return;
            case 3:
                CanJni.HondaAccord7CytAirKey(21);
                return;
            case 4:
                CanJni.HondaAccord7CytAirKey(2);
                return;
            case 5:
                CanJni.HondaAccord7CytAirKey(16);
                return;
            case 6:
                CanJni.HondaAccord7CytAirKey(35);
                return;
            case 8:
                CanJni.HondaAccord7CytAirKey(3);
                return;
            case 9:
                CanJni.HondaAccord7CytAirKey(4);
                return;
            case 10:
                CanJni.HondaAccord7CytAirKey(1);
                return;
            case 15:
                CanJni.HondaAccord7CytAirKey(11);
                return;
            case 16:
                CanJni.HondaAccord7CytAirKey(12);
                return;
            case 20:
                CanJni.HondaAccord7CytAirKey(8);
                return;
            case 21:
                CanJni.HondaAccord7CytAirKey(17);
                return;
            default:
                return;
        }
