...
public class CanAccordCarTypeActivity extends CanBaseActivity implements View.OnClickListener, UserCallBack, CanItemPopupList.onPopItemClick {
    private static final int ITEM_MAX = 1;
    private static final int ITEM_MIN = 1;
    public static final int ITEM_TYPE = 1;
    public static final String TAG = "CanAccordCarTypeActivity";
    private static final int[] mTypeArr = {R.string.can_gcdp, R.string.can_usdp, R.string.can_gczp, R.string.can_gc2016};
