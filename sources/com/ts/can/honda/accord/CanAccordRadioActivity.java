...
public class CanAccordRadioActivity extends CanBaseActivity implements UserCallBack, View.OnClickListener, View.OnLongClickListener {
    ...
    public static final String TAG = "CanAccordRadioActivity";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.mImgMainFreq.setUserPaint(new CustomImgView.onPaint() {
            public boolean userPaint(CustomImgView view, Canvas canvas, Paint paint) {
                if (!(CanAccordRadioActivity.this.mCurFreqData.UpdateOnce == 0 || CanAccordRadioActivity.this.mCurFreqData.CurFreq == 0)) {
                    int Bai = (CanAccordRadioActivity.this.mCurFreqData.CurFreq / 100) % 10;
                    int Shi = (CanAccordRadioActivity.this.mCurFreqData.CurFreq / 10) % 10;
                    int Ge = CanAccordRadioActivity.this.mCurFreqData.CurFreq % 10;
                    if (CanAccordRadioActivity.this.mCurFreqData.Band != 0) {
                        if (CanAccordRadioActivity.this.mCurFreqData.CurFreq >= 1000) {
                            view.drawImage(CanAccordRadioActivity.mFreqNumArr[1], 396, 0);
                        }
                        view.drawImage(CanAccordRadioActivity.mFreqNumArr[Bai], 444, 0);
                        view.drawImage(CanAccordRadioActivity.mFreqNumArr[Shi], 492, 0);
                        view.drawImage(CanAccordRadioActivity.mFreqNumArr[Ge], CanCameraUI.BTN_NISSAN_XTRAL_RVS_ASSIST1, 0);
                    } else {
                        if (CanAccordRadioActivity.this.mCurFreqData.CurFreq >= 1000) {
                            view.drawImage(CanAccordRadioActivity.mFreqNumArr[1], 386, 0);
                        }
                        view.drawImage(CanAccordRadioActivity.mFreqNumArr[Bai], 434, 0);
                        view.drawImage(CanAccordRadioActivity.mFreqNumArr[Shi], 482, 0);
                        view.drawImage(CanAccordRadioActivity.mFreqNumArr[Ge], 551, 0);
        ...
        this.mBtnFm = this.mManager.AddButton(47, 353);
        ...
        this.mBtnAm = this.mManager.AddButton(Can.CAN_JIANGLING_MYX, 353);
        ...
        this.mBtnPreset = this.mManager.AddButton(406, 353);
        ...
        this.mBtnList = this.mManager.AddButton(638, 353);
        ...
        this.mBtnScan = this.mManager.AddButton(KeyDef.SKEY_CALLUP_5, 353);
    ...
    private void UpdateMainFreq(boolean check) {
        if (this.mCurFreqData.UpdateOnce != 0) {
            if (!check || this.mCurFreqData.Update != 0) {
                Log.d("CanAccordRadioActivity", "UpdateMainFreq");
    ...
    public void AccordRadioCtrl(int cmd, int para) {
        CanJni.AccordRadioCtrl(cmd, para);
    }
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            case 1:
                AccordRadioCtrl(53, 1);
                return;
            case 2:
                AccordRadioCtrl(53, 2);
                return;
            case 3:
                AccordRadioCtrl(48, 2);
                return;
            case 4:
                AccordRadioCtrl(48, 1);
                return;
            case 5:
                AccordRadioCtrl(56, 1);
                return;
            case 6:
                AccordRadioCtrl(56, 2);
                return;
            case 7:
                ShowPage(1);
                return;
            case 8:
                ...
                return;
            case 9:
                AccordRadioCtrl(49, 1);
                return;
            case 10:
                AccordRadioCtrl(52, 1);
                return;
            default:
                if (id >= 16 && id <= 28) {
                    AccordRadioCtrl(55, id - 16);
                    return;
                } else if (id >= 32 && id <= 62) {
                    AccordRadioCtrl(54, id - 32);
                    ShowPage(0);
                    return;
                } else {
                    return;
