...
public class CanAccordScreenActivity extends CanAccordBaseActivity implements View.OnClickListener, UserCallBack, CanItemPopupList.onPopItemClick, CanItemProgressList.onPosChange {
    ...
    public static final String TAG = "CanAccrodScreenActivity";
    ...
    public void ResetData(boolean check) {
        ...
        if (!check || i2b(this.mSetData.Update)) {
            ...
            if (this.mSetData.AdjustOutTemp > 0) {
