...
public class CanGolfSetDriveAssActivity extends CanGolfBaseActivity implements CanItemPopupList.onPopItemClick, View.OnClickListener, UserCallBack {
    ...
    public CanItemBlankTextList AddTitleItem(int resId) {
        return new CanItemBlankTextList((Context) this, resId);
    }
