...
public class CanCCWcCarInfoView extends CanScrollCarInfoView {
    public CanCCWcCarInfoView(Activity activity) {
        super(activity, 4);
    }
    ...
    public void InitData() {
        this.mItemTitleIds = new int[]{R.string.can_car_type_select, R.string.can_amp_set, R.string.can_car_set, R.string.can_lang_set};
