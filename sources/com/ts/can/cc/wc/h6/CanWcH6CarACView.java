...
public class CanWcH6CarACView extends CanBaseACView {
    ...
    public CanWcH6CarACView(Activity activity) {
        super(activity);
    }
    ...
    private void SendKey(int id, int key) {
        switch (id) {
            case 0:
                CanJni.CcH6WcCarAirKey(13, key);
                return;
            case 1:
                CanJni.CcH6WcCarAirKey(14, key);
                return;
            case 2:
                CanJni.CcH6WcCarAirKey(11, key);
                return;
            case 3:
                CanJni.CcH6WcCarAirKey(12, key);
                return;
            case 4:
                CanJni.CcH6WcCarAirKey(4, key);
                return;
            case 5:
                CanJni.CcH6WcCarAirKey(2, key);
                return;
            case 6:
                CanJni.CcH6WcCarAirKey(7, key);
                return;
            case 8:
                CanJni.CcH6WcCarAirKey(5, key);
                return;
            case 9:
                CanJni.CcH6WcCarAirKey(6, key);
                return;
            case 10:
                CanJni.CcH6WcCarAirKey(1, key);
                return;
            case 11:
                CanJni.CcH6WcCarAirKey(28, key);
                return;
            case 12:
                CanJni.CcH6WcCarAirKey(26, key);
                return;
            case 13:
                CanJni.CcH6WcCarAirKey(29, key);
                return;
            case 14:
                CanJni.CcH6WcCarAirKey(15, key);
                return;
            case 15:
                CanJni.CcH6WcCarAirKey(16, key);
                return;
            case 19:
                CanJni.CcH6WcCarAirKey(41, key);
                return;
            case 20:
                CanJni.CcH6WcCarAirKey(27, key);
                return;
            default:
                return;
        }
