...
public class CanHfDjCarInfoView extends CanScrollCarInfoView {
    public static final int ITEM_AMP_SET = 0;
    public static final String TAG = "CanHfDjCarInfoView";

    public CanHfDjCarInfoView(Activity activity) {
        super(activity, 5);
    }
    ...
    public void InitData() {
        this.mItemTitleIds = new int[]{R.string.can_vehi_setup, R.string.can_vehi_status, R.string.can_vehicle_slope, R.string.can_seat_status, R.string.can_amp_set};
