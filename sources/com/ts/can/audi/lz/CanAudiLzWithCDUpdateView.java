...
public class CanAudiLzWithCDUpdateView extends CanRelativeCarInfoView {
    public static final String TAG = "CanAudiLzWithCDUpdateView";
    ...
    private View.OnClickListener McuUpdateClick = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            if (id == R.id.mcu_update_start) {
                CanAudiLzWithCDUpdateView.this.mUpdater.startUpdate();
            } else if (id == R.id.mcu_update_reset && CanAudiLzWithCDUpdateView.this.mUpdater.getIapSta() == 2) {
                Mcu.SendXKey(19);
            }
        }
    };
    ...
    private CanDataInfo.AudiWithCdLz_OperationMsg m_Opera;
    private Boolean mcheck;
    /* access modifiers changed from: private */
    public Runnable runnable = new Runnable() {
        public void run() {
            CanAudiLzWithCDUpdateView.this.onTimer();
            CanAudiLzWithCDUpdateView.handler.postDelayed(CanAudiLzWithCDUpdateView.this.runnable, 30);
        }
    };

    public CanAudiLzWithCDUpdateView(Activity activity) {
        super(activity);
    }
    ...
    private void initScreen() {
        ...
        this.m_Opera = new CanDataInfo.AudiWithCdLz_OperationMsg();
        ...
        this.mReset.setOnClickListener(new View.OnClickListener() {
            public void onClick(View arg0) {
                if (CanAudiLzWithCDUpdateView.this.mUpdater.getIapSta() == 2) {
                    Mcu.SendXKey(19);
                }
            }
        });
    ...
    public void onTimer() {
        ...
        CanJni.AudiLzGetOperationMsg(this.m_Opera);
