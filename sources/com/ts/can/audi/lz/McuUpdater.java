...
/* compiled from: CanAudiLzWithCDUpdateView */
class McuUpdater {
    ...
    private CanDataInfo.AudiWithCdLz_UpdateIndex m_IapData = new CanDataInfo.AudiWithCdLz_UpdateIndex();
    private CanDataInfo.AudiWithCdLz_UpdateInfo m_IapSta = new CanDataInfo.AudiWithCdLz_UpdateInfo();
    ...
    public int main() {
        CanJni.AudiLzGetUpdateInfo(this.m_IapSta);
        ...
        CanJni.AudiLzGetUpdateIndex(this.m_IapData);
    ...
    public com.ts.can.audi.lz.McuUpdater.FileInfo getFileData(java.lang.String r9) {
        /*
            r8 = this;
            com.ts.can.audi.lz.McuUpdater$FileInfo r5 = new com.ts.can.audi.lz.McuUpdater$FileInfo
            r5.<init>()
            r7 = 0
            r5.len = r7
        ...
        L_0x0080:
            ...
            goto L_0x003f
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ts.can.audi.lz.McuUpdater.getFileData(java.lang.String):com.ts.can.audi.lz.McuUpdater$FileInfo");
    }
