...
public class CanAudiXbsWithCdACBox implements UserCallBack {
    private static final String TAG = "CanAudiXbsWithCdACBox";
    ...
    private static CanAudiXbsWithCdACBox sInstance;
    private CanDataInfo.CAN_ACInfo mACInfo;
    private CanDataInfo.AudiWithCdXbs_AirInfo mAirInfo = new CanDataInfo.AudiWithCdXbs_AirInfo();
    ...
    private CanAudiXbsWithCdACBox() {
    }

    public static CanAudiXbsWithCdACBox GetInstance() {
        if (sInstance == null) {
            sInstance = new CanAudiXbsWithCdACBox();
        }
        return sInstance;
    }
    ...
    public void ShowAC() {
        if (!mIsAC) {
            CanJni.AudiWithCdXbsGetAirInfo(this.mAirInfo);
