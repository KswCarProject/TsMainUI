...
public class CanAudiWithCDUpdateActivity extends Activity {
    public static final String TAG = "CanAudiWithCDUpdateActivity";
    ...
    private View.OnClickListener McuUpdateClick = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            if (id == R.id.mcu_update_start) {
                CanAudiWithCDUpdateActivity.this.mUpdater.startUpdate();
            } else if (id == R.id.mcu_update_reset && CanAudiWithCDUpdateActivity.this.mUpdater.getIapSta() == 65535) {
                Mcu.SendXKey(19);
            }
        }
    };
    ...
    private CanDataInfo.AudiZmyt_OperationMsg m_Opera = new CanDataInfo.AudiZmyt_OperationMsg();
    private Boolean mcheck;
    /* access modifiers changed from: private */
    public Runnable runnable = new Runnable() {
        public void run() {
            CanAudiWithCDUpdateActivity.this.onTimer();
            CanAudiWithCDUpdateActivity.handler.postDelayed(CanAudiWithCDUpdateActivity.this.runnable, 30);
        }
    };
    ...
    public void onTimer() {
        ...
        CanJni.AudiZmytGetOperationMsg(this.m_Opera);
