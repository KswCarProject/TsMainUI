...
public class CanAudiWithCDCarInfoView extends CanScrollCarInfoView {
    ...
    public CanAudiWithCDCarInfoView(Activity activity) {
        super(activity, 3);
    }
        ...
        if (action != 0) {
            ...
            switch (id) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    enterSubWin(CanAudiWithCDUpdateActivity.class);
                    break;
            }
        }
        return false;
