...
public class CanAudiWithCDCarInitView extends CanScrollCarInfoView implements CanItemMsgBox.onMsgBoxClick {
    ...
    public void InitData() {
        ...
        if (CanFunc.getInstance().IsCore() != 1) {
            ...
            this.mPopValueIds[3] = new int[]{R.array.can_res_audi_num};
        }
    ...
    public void ResetData(boolean r28) {
        ...
        L_0x0584:
            ...
            goto L_0x03dd
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ts.can.audi.xhd.CanAudiWithCDCarInitView.ResetData(boolean):void");
    }
