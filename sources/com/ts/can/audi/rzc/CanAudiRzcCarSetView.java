...
public class CanAudiRzcCarSetView extends CanRelativeCarInfoView {
    public static final String TAG = "CanAudiRzcCarSetView";
    ...
    private CanDataInfo.AudiRzcCarInfo mSetData1;
    private CanDataInfo.AudiRzcCarInfo2 mSetData2;
    private CanDataInfo.AudiRzcCarInfo3 mSetData3;
    ...
    public CanAudiRzcCarSetView(Activity activity) {
        super(activity);
    }
    ...
    public void InitUI() {
        this.mSetData1 = new CanDataInfo.AudiRzcCarInfo();
        this.mSetData2 = new CanDataInfo.AudiRzcCarInfo2();
        this.mSetData3 = new CanDataInfo.AudiRzcCarInfo3();
    ...
    public void ResetData(boolean check) {
        CanJni.AudiRzcGetCarInfo(this.mSetData1);
        if (i2b(this.mSetData1.UpdateOnce) && (!check || i2b(this.mSetData1.Update))) {
            this.mSetData1.Update = 0;
            if (i2b(this.mSetData1.fgAQD)) {
            ...
            if (i2b(this.mSetData1.fgQSY)) {
                this.mQxyIcon.setSelected(true);
                this.mQxyItemTxt.setText(R.string.can_wash_lower);
            } else {
                this.mQxyIcon.setSelected(false);
                this.mQxyItemTxt.setText(R.string.can_wash_normal);
            }
            boolean fgSS = i2b(this.mSetData1.fgSS);
            Log.d("lq", "mSetData1.fgSS:" + fgSS);
            if (fgSS) {
        ...
        CanJni.AudiRzcGetCarInfo2(this.mSetData2);
        if (i2b(this.mSetData2.UpdateOnce) && (!check || i2b(this.mSetData2.Update))) {
            this.mSetData2.Update = 0;
            this.mRPMItem.setText(String.format("%dRPM", new Object[]{Integer.valueOf(this.mSetData2.Rpm)}));
            this.mSpeedItem.setText(String.format("%dKm/h", new Object[]{Integer.valueOf(this.mSetData2.Speed)}));
            this.mDistanceItem.setText(String.format("%dKm", new Object[]{Integer.valueOf(this.mSetData2.Distance)}));
            this.mElctricItem.setText(String.format("%.2fV", new Object[]{Float.valueOf(((float) this.mSetData2.BatV) * 0.01f)}));
            this.mTempItem.setText(String.format("%.1f℃", new Object[]{Float.valueOf(((float) this.mSetData2.OutTemp) * 0.1f)}));
            this.mOilItem.setText(String.format("%dL", new Object[]{Integer.valueOf(this.mSetData2.Syyl)}));
        }
        CanJni.AudiRzcGetCarInfo3(this.mSetData3);
        if (!i2b(this.mSetData3.UpdateOnce)) {
            return;
        }
        if (!check || i2b(this.mSetData3.Update)) {
            this.mSetData3.Update = 0;
            boolean fgWarnOil = i2b(this.mSetData3.fgWarnOil);
            boolean fgWarnBat = i2b(this.mSetData3.fgWarnBat);
    ...
    public void QueryData() {
        CanJni.AudiRzcQueryData(65, 1);
        Sleep(5);
        CanJni.AudiRzcQueryData(65, 2);
        Sleep(5);
        CanJni.AudiRzcQueryData(65, 3);
    }
