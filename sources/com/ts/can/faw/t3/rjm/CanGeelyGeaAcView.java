...
public class CanGeelyGeaAcView extends CanBaseACView {
    ...
    public CanGeelyGeaAcView(Activity activity) {
        super(activity);
    }
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        if (action != 0) {
            if (1 == action) {
                switch (Id) {
                    case 2:
                        CanJni.T3FlAirCmd(8, 0);
                        break;
                    case 3:
                        CanJni.T3FlAirCmd(6, 0);
                        break;
                    case 4:
                        CanJni.T3FlAirCmd(3, 0);
                        break;
                    case 5:
                        CanJni.T3FlAirCmd(5, 0);
                        break;
                    case 6:
                        CanJni.T3FlAirCmd(2, 0);
                        break;
                    case 7:
                        CanJni.T3FlAirCmd(21, 0);
                        break;
                    case 8:
                        CanJni.T3FlAirCmd(22, 0);
                        break;
                    case 9:
                        CanJni.T3FlAirCmd(17, 0);
                        break;
                    case 11:
                        CanJni.T3FlAirCmd(18, 0);
                        break;
                    case 13:
                        CanJni.T3FlAirCmd(23, 0);
                        break;
                    case 14:
                        CanJni.T3FlAirCmd(24, 0);
                        break;
                    case 17:
                        CanJni.T3FlAirCmd(1, 0);
                        break;
                    case 18:
                        CanJni.T3FlAirCmd(14, 0);
                        break;
                    case 19:
                        CanJni.T3FlAirCmd(13, 0);
                        break;
                    case 20:
                        CanJni.T3FlAirCmd(9, 0);
                        break;
                    case 21:
                        CanJni.T3FlAirCmd(16, 0);
                        break;
                    case 22:
                        CanJni.T3FlAirCmd(15, 0);
                        break;
                }
            }
        } else {
            switch (Id) {
                case 2:
                    CanJni.T3FlAirCmd(8, 1);
                    break;
                case 3:
                    CanJni.T3FlAirCmd(6, 1);
                    break;
                case 4:
                    CanJni.T3FlAirCmd(3, 1);
                    break;
                case 5:
                    CanJni.T3FlAirCmd(5, 1);
                    break;
                case 6:
                    CanJni.T3FlAirCmd(2, 1);
                    break;
                case 7:
                    CanJni.T3FlAirCmd(21, 1);
                    break;
                case 8:
                    CanJni.T3FlAirCmd(22, 1);
                    break;
                case 9:
                    CanJni.T3FlAirCmd(17, 1);
                    break;
                case 11:
                    CanJni.T3FlAirCmd(18, 1);
                    break;
                case 13:
                    CanJni.T3FlAirCmd(23, 1);
                    break;
                case 14:
                    CanJni.T3FlAirCmd(24, 1);
                    break;
                case 17:
                    CanJni.T3FlAirCmd(1, 1);
                    break;
                case 18:
                    CanJni.T3FlAirCmd(14, 1);
                    break;
                case 19:
                    CanJni.T3FlAirCmd(13, 1);
                    break;
                case 20:
                    CanJni.T3FlAirCmd(9, 1);
                    break;
                case 21:
                    CanJni.T3FlAirCmd(16, 1);
                    break;
                case 22:
                    CanJni.T3FlAirCmd(15, 1);
                    break;
            }
        }
        return false;
    ...
    private void BaseUI() {
        ...
        this.mBtnWdUp = AddBtn(21, 604, 164, R.drawable.can_jeep_ac_09_up, R.drawable.can_jeep_ac_09_dn);
