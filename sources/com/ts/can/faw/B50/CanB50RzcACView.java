...
public class CanB50RzcACView extends CanBaseACView {
    ...
    public CanB50RzcACView(Activity activity) {
        super(activity);
    }
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        if (action != 0) {
            if (1 == action) {
                switch (Id) {
                    case 2:
                        CanJni.B50RzcAcKey(1, 0);
                        break;
                    case 3:
                        CanJni.B50RzcAcKey(21, 0);
                        break;
                    case 4:
                        CanJni.B50RzcAcKey(2, 0);
                        break;
                    case 5:
                        CanJni.B50RzcAcKey(6, 0);
                        break;
                    case 6:
                        CanJni.B50RzcAcKey(23, 0);
                        break;
                    case 7:
                        CanJni.B50RzcAcKey(13, 0);
                        break;
                    case 8:
                        CanJni.B50RzcAcKey(14, 0);
                        break;
                    case 9:
                        CanJni.B50RzcAcKey(7, 0);
                        break;
                    case 10:
                        CanJni.B50RzcAcKey(8, 0);
                        break;
                    case 11:
                        CanJni.B50RzcAcKey(9, 0);
                        break;
                    case 12:
                        CanJni.B50RzcAcKey(10, 0);
                        break;
                    case 13:
                        CanJni.B50RzcAcKey(13, 0);
                        break;
                    case 14:
                        ...
                        break;
                    case 17:
                        CanJni.B50RzcAcKey(0, 0);
                        break;
                    case 18:
                        CanJni.B50RzcAcKey(12, 0);
                        break;
                    case 19:
                        CanJni.B50RzcAcKey(11, 0);
                        break;
                    case 22:
                        CanJni.B50RzcAcKey(17, 0);
                        break;
                }
            }
        } else {
            switch (Id) {
                case 2:
                    CanJni.B50RzcAcKey(1, 1);
                    break;
                case 3:
                    CanJni.B50RzcAcKey(21, 1);
                    break;
                case 4:
                    CanJni.B50RzcAcKey(2, 1);
                    break;
                case 5:
                    CanJni.B50RzcAcKey(6, 1);
                    break;
                case 6:
                    CanJni.B50RzcAcKey(23, 1);
                    break;
                case 7:
                    CanJni.B50RzcAcKey(13, 1);
                    break;
                case 8:
                    CanJni.B50RzcAcKey(14, 1);
                    break;
                case 9:
                    CanJni.B50RzcAcKey(7, 1);
                    break;
                case 10:
                    CanJni.B50RzcAcKey(8, 1);
                    break;
                case 11:
                    CanJni.B50RzcAcKey(9, 1);
                    break;
                case 12:
                    CanJni.B50RzcAcKey(10, 1);
                    break;
                case 13:
                    CanJni.B50RzcAcKey(13, 1);
                    break;
                case 14:
                    ...
                    break;
                case 17:
                    CanJni.B50RzcAcKey(0, 1);
                    break;
                case 18:
                    CanJni.B50RzcAcKey(12, 1);
                    break;
                case 19:
                    CanJni.B50RzcAcKey(11, 1);
                    break;
                case 22:
                    CanJni.B50RzcAcKey(17, 1);
                    break;
            }
        }
        return false;
