...
public class CanB70_14PhoneActivity extends CanBaseActivity implements UserCallBack, View.OnClickListener, CanItemProgressList.onPosChange {
    ...
    public static void DealStatus(boolean isCamMode) {
        if (CanJni.B70IsPhoneActive() != 0) {
            if (!isCamMode) {
                CanFunc.showCanActivity(CanB70_14PhoneActivity.class);
            }
