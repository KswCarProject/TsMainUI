...
public class CanJlCarInfoActivity extends CanBaseActivity implements UserCallBack, View.OnClickListener, CanItemProgressList.onPosChange {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.mBtnBms = AddBtn(0, Can.CAN_DFFG_S560, 132, R.drawable.can_jl_jdxx_up, R.drawable.can_jl_jdxx_dn, R.drawable.can_jl_jdxx_warning);
        this.mBtnBattery = AddBtn(1, 345, 132, R.drawable.can_jl_dcxx_up, R.drawable.can_jl_dcxx_dn, R.drawable.can_jl_dcxx_warning);
        this.mBtnSlow = AddBtn(2, 534, 132, R.drawable.can_jl_mc_up, R.drawable.can_jl_mc_dn, R.drawable.can_jl_mc_warning);
        this.mBtnQuick = AddBtn(3, 724, 132, R.drawable.can_jl_kc_up, R.drawable.can_jl_kc_dn, R.drawable.can_jl_kc_warning);
        ...
        this.mTvBms.setText(R.string.can_machine_infos);
        this.mTvBattery.setText(R.string.can_battery_infos);
        this.mTvSlow.setText(R.string.can_low_charging);
        this.mTvQuick.setText(R.string.can_quick_charging);
    ...
    private void ResetData(boolean check) {
        ...
        if (!check || i2b(this.mWarnData.Update)) {
            ...
            SetWarn(this.mBtnBms, this.mWarnData.MachineWarn, R.drawable.can_jl_jdxx_up, R.drawable.can_jl_jdxx_dn, R.drawable.can_jl_jdxx_warning);
            SetWarn(this.mBtnBattery, this.mWarnData.BatteryWarn, R.drawable.can_jl_dcxx_up, R.drawable.can_jl_dcxx_dn, R.drawable.can_jl_dcxx_warning);
            SetWarn(this.mBtnSlow, this.mWarnData.SlowWarn, R.drawable.can_jl_mc_up, R.drawable.can_jl_mc_dn, R.drawable.can_jl_mc_warning);
            SetWarn(this.mBtnQuick, this.mWarnData.QuickWarn, R.drawable.can_jl_kc_up, R.drawable.can_jl_kc_dn, R.drawable.can_jl_kc_warning);
    ...
    public void onClick(View v) {
        switch (((Integer) v.getTag()).intValue()) {
            case 0:
                enterSubWin(CanJlBmsActivity.class);
                return;
            case 1:
                enterSubWin(CanJlBatteryActivity.class);
                return;
            default:
                return;
        }
