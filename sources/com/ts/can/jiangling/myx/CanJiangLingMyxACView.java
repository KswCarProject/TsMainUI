...
public class CanJiangLingMyxACView extends CanBaseACView {
    ...
    public CanJiangLingMyxACView(Activity activity) {
        super(activity);
    }
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        if (action != 0) {
            if (1 == action) {
                switch (Id) {
                    case 2:
                        CanJni.JiangLingMyxAcSet(4, 0);
                        break;
                    case 3:
                        CanJni.JiangLingMyxAcSet(5, 0);
                        break;
                    case 4:
                        CanJni.JiangLingMyxAcSet(9, 0);
                        break;
                    case 5:
                        CanJni.JiangLingMyxAcSet(7, 0);
                        break;
                    case 6:
                        CanJni.JiangLingMyxAcSet(6, 0);
                        break;
                    case 7:
                        CanJni.JiangLingMyxAcSet(2, 0);
                        break;
                    case 8:
                        CanJni.JiangLingMyxAcSet(2, 0);
                        break;
                    ...
                    case 14:
                        ...
                        break;
                    case 17:
                        CanJni.JiangLingMyxAcSet(0, 0);
                        break;
                    case 18:
                        CanJni.JiangLingMyxAcSet(1, 0);
                        break;
                    case 19:
                        CanJni.JiangLingMyxAcSet(1, 0);
                        break;
                    case 22:
                        CanJni.JiangLingMyxAcSet(3, 0);
                        break;
                }
            }
        } else {
            switch (Id) {
                case 2:
                    if (this.mACInfo.fgAC != 1) {
                        CanJni.JiangLingMyxAcSet(4, 1);
                        break;
                    } else {
                        CanJni.JiangLingMyxAcSet(4, 2);
                        break;
                    }
                case 3:
                    if (this.mACInfo.fgInnerLoop != 1) {
                        CanJni.JiangLingMyxAcSet(5, 2);
                        break;
                    } else {
                        CanJni.JiangLingMyxAcSet(5, 1);
                        break;
                    }
                case 4:
                    if (this.mACInfo.nAutoLight != 1) {
                        CanJni.JiangLingMyxAcSet(9, 1);
                        break;
                    } else {
                        CanJni.JiangLingMyxAcSet(9, 2);
                        break;
                    }
                case 5:
                    if (this.mACInfo.fgDFBL != 1) {
                        CanJni.JiangLingMyxAcSet(7, 1);
                        break;
                    } else {
                        CanJni.JiangLingMyxAcSet(7, 2);
                        break;
                    }
                case 6:
                    if (this.mACInfo.fgRearLight != 1) {
                        CanJni.JiangLingMyxAcSet(6, 1);
                        break;
                    } else {
                        CanJni.JiangLingMyxAcSet(6, 2);
                        break;
                    }
                case 7:
                    CanJni.JiangLingMyxAcSet(2, 1);
                    break;
                case 8:
                    CanJni.JiangLingMyxAcSet(2, 2);
                    break;
                case 13:
                    CanJni.JiangLingMyxAcSet(2, 1);
                    break;
                case 14:
                    ...
                    break;
                case 17:
                    CanJni.JiangLingMyxAcSet(0, 1);
                    break;
                case 18:
                    CanJni.JiangLingMyxAcSet(1, 2);
                    break;
                case 19:
                    CanJni.JiangLingMyxAcSet(1, 1);
                    break;
                case 22:
                    CanJni.JiangLingMyxAcSet(3, 1);
                    break;
            }
        }
        return false;
    ...
    private void initCommonScreen() {
        ...
        this.mBtnWdPx = AddBtn(9, KeyDef.RKEY_CMMB_PBC, 190, R.drawable.can_jeep_ac_01_up, R.drawable.can_jeep_ac_01_dn);
        this.mBtnWdDn = AddBtn(11, 460, 190, R.drawable.can_jeep_ac_03_up, R.drawable.can_jeep_ac_03_dn);
        this.mBtnWdUp = AddBtn(21, 607, 190, R.drawable.can_jeep_ac_09_up, R.drawable.can_jeep_ac_09_dn);
