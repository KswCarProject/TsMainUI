...
public class CanKaWeiWcACView extends CanBaseACView {
    ...
    public CanKaWeiWcACView(Activity activity) {
        super(activity);
    }
    ...
    private void sendCmd(int Id, int para) {
        switch (Id) {
            case 2:
                CanJni.KaWWcAirCmd(2, para);
                return;
            case 3:
                CanJni.KaWWcAirCmd(7, para);
                return;
            case 4:
                CanJni.KaWWcAirCmd(4, para);
                return;
            case 5:
                CanJni.KaWWcAirCmd(5, para);
                return;
            case 7:
                CanJni.KaWWcAirCmd(13, para);
                return;
            case 8:
                CanJni.KaWWcAirCmd(14, para);
                return;
            case 9:
                CanJni.KaWWcAirCmd(26, para);
                return;
            case 10:
                CanJni.KaWWcAirCmd(27, para);
                return;
            case 11:
                CanJni.KaWWcAirCmd(29, para);
                return;
            case 12:
                CanJni.KaWWcAirCmd(28, para);
                return;
            case 13:
                CanJni.KaWWcAirCmd(13, para);
                return;
            case 14:
                ...
                return;
            case 17:
                CanJni.KaWWcAirCmd(1, para);
                return;
            case 18:
                CanJni.KaWWcAirCmd(12, para);
                return;
            case 19:
                CanJni.KaWWcAirCmd(11, para);
                return;
            default:
                return;
        }
