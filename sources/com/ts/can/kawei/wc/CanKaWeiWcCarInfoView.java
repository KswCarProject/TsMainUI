...
public class CanKaWeiWcCarInfoView extends CanScrollCarInfoView {
    public CanKaWeiWcCarInfoView(Activity activity) {
        super(activity, 1);
    }
    ...
    public void InitData() {
        this.mItemTitleIds = new int[]{R.string.can_tpms};
