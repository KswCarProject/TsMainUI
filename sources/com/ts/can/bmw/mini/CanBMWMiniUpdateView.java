...
public class CanBMWMiniUpdateView extends CanRelativeCarInfoView {
    public static final String TAG = "CanBMWZMYTUpdateView";
    ...
    private View.OnClickListener McuUpdateClick = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            if (id == R.id.mcu_update_start) {
                CanBMWMiniUpdateView.this.mUpdater.startUpdate();
            } else if (id == R.id.mcu_update_reset && CanBMWMiniUpdateView.this.mUpdater.getIapSta() == 65535) {
                Mcu.SendXKey(19);
            }
        }
    };
    ...
    public Runnable runnable = new Runnable() {
        public void run() {
            CanBMWMiniUpdateView.this.onTimer();
            CanBMWMiniUpdateView.handler.postDelayed(CanBMWMiniUpdateView.this.runnable, 30);
        }
    };

    public CanBMWMiniUpdateView(Activity activity) {
        super(activity);
    }
    ...
    private void initScreen() {
        ...
        this.mReset.setOnClickListener(new View.OnClickListener() {
            public void onClick(View arg0) {
                if (CanBMWMiniUpdateView.this.mUpdater.getIapSta() == 65535) {
                    Mcu.SendXKey(19);
                }
            }
        });
