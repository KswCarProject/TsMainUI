...
public class CanBmwZmytWithCDUpdateActivity extends Activity {
    public static final String TAG = "CanBmwZmytWithCDUpdateActivity";
    ...
    private View.OnClickListener McuUpdateClick = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            if (id == R.id.mcu_update_start) {
                CanBmwZmytWithCDUpdateActivity.this.mUpdater.startUpdate();
            } else if (id == R.id.mcu_update_reset && CanBmwZmytWithCDUpdateActivity.this.mUpdater.getIapSta() == 65535) {
                Mcu.SendXKey(19);
            }
        }
    };
    ...
    public Runnable runnable = new Runnable() {
        public void run() {
            CanBmwZmytWithCDUpdateActivity.this.onTimer();
            CanBmwZmytWithCDUpdateActivity.handler.postDelayed(CanBmwZmytWithCDUpdateActivity.this.runnable, 30);
        }
    };
