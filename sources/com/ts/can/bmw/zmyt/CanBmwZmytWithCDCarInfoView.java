...
public class CanBmwZmytWithCDCarInfoView extends CanScrollCarInfoView {
    ...
    public CanBmwZmytWithCDCarInfoView(Activity activity) {
        super(activity, 3);
    }
        ...
        if (action != 0) {
            ...
            switch (id) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    enterSubWin(CanBmwZmytWithCDUpdateActivity.class);
                    break;
            }
        }
        return false;
