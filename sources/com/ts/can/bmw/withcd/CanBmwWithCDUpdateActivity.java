...
public class CanBmwWithCDUpdateActivity extends Activity {
    public static final String TAG = "CanBmwWithCDUpdateActivity";
    ...
    private View.OnClickListener McuUpdateClick = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            if (id == R.id.mcu_update_start) {
                CanBmwWithCDUpdateActivity.this.mUpdater.startUpdate();
            } else if (id == R.id.mcu_update_reset && CanBmwWithCDUpdateActivity.this.mUpdater.getIapSta() == 65535) {
                Mcu.SendXKey(19);
            }
        }
    };
    ...
    public Runnable runnable = new Runnable() {
        public void run() {
            CanBmwWithCDUpdateActivity.this.onTimer();
            CanBmwWithCDUpdateActivity.handler.postDelayed(CanBmwWithCDUpdateActivity.this.runnable, 30);
        }
    };
