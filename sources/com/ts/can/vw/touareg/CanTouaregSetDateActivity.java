...
public class CanTouaregSetDateActivity extends CanBaseActivity implements View.OnClickListener, CanItemPopupList.onPopItemClick, UserCallBack {
    ...
    private static final int[] mArray = {R.string.can_off, R.string.can_on};
    ...
    private DatePickerDialog.OnDateSetListener mDatelistener = new DatePickerDialog.OnDateSetListener() {
        public void onDateSet(DatePicker view, int myyear, int monthOfYear, int dayOfMonth) {
            Log.d(CanBaseActivity.TAG, "您设置了时间：年" + myyear + "月 " + monthOfYear + "日 " + dayOfMonth);
            CanJni.GolfGetTime(CanTouaregSetDateActivity.this.mCurTime);
            CanTouaregSetDateActivity.this.mCurTime.Year = myyear;
            CanTouaregSetDateActivity.this.mCurTime.Month = monthOfYear + 1;
            CanTouaregSetDateActivity.this.mCurTime.Day = dayOfMonth;
            CanJni.GolfSetTime(CanTouaregSetDateActivity.this.mCurTime);
        }
    };
    private CanItemPopupList mItemDate;
    private CanItemPopupList mItemTime;
    private CanItemPopupList mItemTimeFmt;
    private CanItemPopupList mItemZdxls;
    ...
    private TimePickerDialog.OnTimeSetListener mTimeListener = new TimePickerDialog.OnTimeSetListener() {
        public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
            ...
            CanJni.GolfGetTime(CanTouaregSetDateActivity.this.mCurTime);
            CanTouaregSetDateActivity.this.mCurTime.Hour = hourOfDay;
            CanTouaregSetDateActivity.this.mCurTime.Min = minute;
            CanJni.GolfSetTime(CanTouaregSetDateActivity.this.mCurTime);
        }
    };
    ...
    public void ResetData(boolean check) {
        ...
        if (!check || i2b(this.mTimeData.Update)) {
            ...
            this.mItemZdxls.SetSel(this.mTimeData.AST);
        }
    }
    ...
    public void InitUI() {
        ...
        this.mItemZdxls = new CanItemPopupList((Context) this, R.string.can_zdxls, mArray, (CanItemPopupList.onPopItemClick) this);
