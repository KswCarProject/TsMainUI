...
public class CanCarVwWcACActivity extends CanBaseActivity implements UserCallBack {
    private static int AC_SHOW_TIME = TXZPoiSearchManager.DEFAULT_NEARBY_RADIUS;
    public static final String TAG = "CanCarVwWcACActivity";
    ...
    private CustomImgView[] mLeftWind = new CustomImgView[7];
    ...
    private CustomImgView[] mRightWind = new CustomImgView[7];
    ...
    private ImageView[] mWindFrontWidnSmall = new ImageView[2];
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_can_ac_vw);
        ...
        this.mWindFrontWidnSmall[0] = (ImageView) findViewById(R.id.can_ac_frontwind_l_up);
        this.mWindFrontWidnSmall[1] = (ImageView) findViewById(R.id.can_ac_frontwind_r_up);
        ...
        for (int i3 = 0; i3 < this.mRightWind.length; i3++) {
            this.mRightWind[i3] = this.mManager.AddImage((i3 * 26) + 278, 460, 23, 50);
        ...
        for (int i4 = 0; i4 < this.mLeftWind.length; i4++) {
            this.mLeftWind[i4] = this.mManager.AddImage((i4 * 26) + CanCameraUI.BTN_CHANA_CS75_MODE3, 460, 23, 50);
