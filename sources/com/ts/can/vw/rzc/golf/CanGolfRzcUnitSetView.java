...
public class CanGolfRzcUnitSetView extends CanScrollCarInfoView {
    ...
    public void InitUI() {
        ...
        this.mItemObjects[2] = getScrollManager().addItemPopupList(this.mItemTitleIds[2], mTempDW, 2, (CanItemPopupList.onPopItemClick) this);
        this.mItemObjects[3] = getScrollManager().addItemPopupList(this.mItemTitleIds[3], mVolumeDW, 3, (CanItemPopupList.onPopItemClick) this);
