...
public class CanGolfRzcDriveAssSetView extends CanScrollCarInfoView {
    ...
    public void ResetData(boolean check) {
        ...
        if (i2b(this.mAss2Data.UpdateOnce) && (!check || i2b(this.mAss2Data.Update))) {
            ...
            updateItem(18, this.mAss2Data.Bdfzxtld, String.format("%d", new Object[]{Integer.valueOf(this.mAss2Data.Bdfzxtld + 1)}));
        }
