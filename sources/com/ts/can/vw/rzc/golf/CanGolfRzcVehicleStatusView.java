    ...
    public void onClick(View v) {
        ...
        switch (Id) {
            ...
            case 5:
                ...
                return;
            case 6:
                new CanPopupDialog((Context) getActivity(), this.mTyresArray, this.mTyresData.Zjstyjc, v, (CanPopupDialog.OnItemClick) new CanPopupDialog.OnItemClick() {
            ...
            if (i2b(this.mReportData.UpdateOnce)) {
                if (!check || i2b(this.mReportData.Update)) {
                    ...
                    if (this.mReportData.Num == 0) {
                        ...
                        this.mBtnReports.setText(String.format("%d %s", new Object[]{Integer.valueOf(this.mReportData.Num), getString(R.string.can_gf_reports)}));
                    }
                }
            } else if (!check) {
