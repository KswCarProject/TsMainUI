...
public class CanGolfRzcEleDZXSView extends CanRelativeCarInfoView {
    ...
    public void ResetData(boolean check) {
        ...
        if (!check || i2b(this.mSetData.Update)) {
            ...
            if (this.mSetData.Xhqn < 10) {
                ...
                this.mTxtXHQN.setText(String.valueOf(getActivity().getResources().getString(R.string.can_xhqn)) + String.format(":  %d km", new Object[]{Integer.valueOf(this.mSetData.Xhqn / 10)}));
            }
            this.mTxtDCXH.setText(String.valueOf(getActivity().getResources().getString(R.string.can_dcxh)) + String.format(":  %d km", new Object[]{Integer.valueOf(this.mSetData.Dcxh / 10)}));
            this.mTxtXSLC.setText(String.valueOf(getActivity().getResources().getString(R.string.can_dis_trav)) + String.format(":  %d km", new Object[]{Integer.valueOf(this.mSetData.Xslc / 10)}));
            this.mTxtLPFLC.setText(String.valueOf(getActivity().getResources().getString(R.string.can_lpflc)) + String.format(":  %d km", new Object[]{Integer.valueOf(this.mSetData.Lpf / 10)}));
            this.mTxtLPFBL.setText(String.valueOf(getActivity().getResources().getString(R.string.can_lpfbl)) + String.format(":  %d %%", new Object[]{Integer.valueOf(this.mSetData.Bl)}));
        }
    }
