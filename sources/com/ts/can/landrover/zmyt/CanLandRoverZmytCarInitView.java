...
public class CanLandRoverZmytCarInitView extends CanScrollCarInfoView implements CanItemMsgBox.onMsgBoxClick {
    private static final int ITEM_AUX_CONFIG = 0;
    private static final int ITEM_CAR_DOOR_UI = 3;
    private static final int ITEM_HOST_RES = 2;
    private static final int ITEM_KEY_TYPE = 7;
    private static final int ITEM_LVDS_TYPE = 5;
    private static final int ITEM_MAX = 7;
    private static final int ITEM_MIN = 0;
    private static final int ITEM_RES_AUTO = 4;
    private static final int ITEM_SLEEP_TIME = 1;
    private static final int ITEM_TW8836_PARA = 6;
    ...
    private static int m_KeyTypeb = 0;
    private static int m_LvdsTypeb = 0;
    private static int m_ResAutoCnt = 0;
    private static int m_Tw8836_Parab = 0;
    private CanDataInfo.CanLandRoverConfig m_SetData;

    public CanLandRoverZmytCarInitView(Activity activity) {
        super(activity, 8);
    }

    /* access modifiers changed from: protected */
    public void InitData() {
        this.mItemTitleIds = new int[]{R.string.can_audi_aux_config, R.string.can_jmqxmsj, R.string.can_host_res, R.string.can_door_ui, R.string.can_Resolution_adaptive, R.string.can_lvds_type, R.string.can_disp_type, R.string.can_ycan_type};
        this.mItemTypes = new CanScrollCarInfoView.Item[]{CanScrollCarInfoView.Item.POP, CanScrollCarInfoView.Item.PROGRESS, CanScrollCarInfoView.Item.POP, CanScrollCarInfoView.Item.POP, CanScrollCarInfoView.Item.TITLE, CanScrollCarInfoView.Item.POP, CanScrollCarInfoView.Item.POP, CanScrollCarInfoView.Item.POP};
        this.mPopValueIds[0] = new int[]{R.array.can_landrover_ent_dev_arrays};
        ...
        if (CanFunc.getInstance().IsCore() != 1) {
            this.mPopValueIds[2] = new int[]{R.array.can_digital_arr};
        } else {
            this.mPopValueIds[2] = new int[]{R.array.can_res_num};
        }
        this.mPopValueIds[3] = new int[]{R.array.can_door_ui_arr};
        this.mPopValueIds[5] = new int[]{R.array.can_lvds_type};
        this.mPopValueIds[6] = new int[]{R.array.can_disp_para};
        this.mPopValueIds[7] = new int[]{R.array.can_landrover_scr_car_type};
        if (CanFunc.getInstance().IsCore() != 1) {
        ...
        this.m_SetData = new CanDataInfo.CanLandRoverConfig();
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:16:0x00b8, code lost:
        if (i2b(r27.m_SetData.Update) != false) goto L_0x00ba;
     */
    ...
    public void ResetData(boolean r28) {
        ...
        L_0x0083:
            r0 = r27
            com.lgb.canmodule.CanDataInfo$CanLandRoverConfig r0 = r0.m_SetData
            r17 = r0
            com.lgb.canmodule.CanJni.LandRoverZmytGetConfigData(r17)
            r0 = r27
            com.lgb.canmodule.CanDataInfo$CanLandRoverConfig r0 = r0.m_SetData
            r17 = r0
            r0 = r17
        ...
        L_0x05c1:
            ...
            goto L_0x041a
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ts.can.landrover.zmyt.CanLandRoverZmytCarInitView.ResetData(boolean):void");
    }
    ...
    public void onItem(int id, int item) {
        switch (id) {
            ...
            case 2:
                ...
                SetCamType(0, 0, 0);
                if (CanFunc.getInstance().IsCore() == 1) {
                    new CanItemMsgBox(2, getActivity(), R.string.can_car_select_tip, this);
                    return;
                }
                return;
            case 3:
            ...
            case 6:
                ...
                Mcu.SendXKey(DispType() + 75);
                return;
            case 7:
                FtSet.Setlgb1((item << 8) | (FtSet.Getlgb1() & 255));
                return;
            default:
                return;
        }
    ...
    public void onChanged(int id, int pos) {
        switch (id) {
            case 1:
                CanJni.LandRoverZmytReqControl(48, pos);
                return;
            default:
                return;
        }
    ...
    public void QueryData() {
        CanJni.LandRoverZmytQueryInfo(24);
    }
}
