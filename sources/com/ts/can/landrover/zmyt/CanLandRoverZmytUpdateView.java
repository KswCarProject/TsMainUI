...
public class CanLandRoverZmytUpdateView extends CanRelativeCarInfoView {
    public static final String TAG = "CanLandRoverZmytUpdateView";
    ...
    private View.OnClickListener McuUpdateClick = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            if (id == R.id.mcu_update_start) {
                CanLandRoverZmytUpdateView.this.mUpdater.startUpdate();
            } else if (id == R.id.mcu_update_reset && CanLandRoverZmytUpdateView.this.mUpdater.getIapSta() == 65535) {
                Mcu.SendXKey(19);
            }
        }
    };
    ...
    public Runnable runnable = new Runnable() {
        public void run() {
            CanLandRoverZmytUpdateView.this.onTimer();
            CanLandRoverZmytUpdateView.handler.postDelayed(CanLandRoverZmytUpdateView.this.runnable, 30);
        }
    };

    public CanLandRoverZmytUpdateView(Activity activity) {
        super(activity);
    }
    ...
    private void initScreen() {
        ...
        this.mReset.setOnClickListener(new View.OnClickListener() {
            public void onClick(View arg0) {
                if (CanLandRoverZmytUpdateView.this.mUpdater.getIapSta() == 65535) {
                    Mcu.SendXKey(19);
                }
            }
        });
