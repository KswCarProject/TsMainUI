...
public class PhoneBookProvider extends ContentProvider {
    public static final String AUTHORITY = "com.nwd.bt.provider";
    public static Uri AUTHORITY_URI = Uri.parse("content://com.nwd.bt.provider/phonebook");
    ...
    public String getType(Uri uri) {
        switch (mUriMatcher.match(uri)) {
            case 0:
                return "vnd.android.cursor.dir/vnd.com.nwd.bt.provider.phonebook";
            case 1:
                return "vnd.android.cursor.item/vnd.com.nwd.bt.provider.phonebook";
            default:
                return null;
        }
    }
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (mUriMatcher.match(uri)) {
            case 0:
            case 1:
                return Uri.parse("content://com.nwd.bt.provider/phonebook/" + db.insert("phonebook", (String) null, values));
            default:
                return null;
        }
    }
