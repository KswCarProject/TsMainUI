...
final class EANManufacturerOrgSupport {
    ...
    private synchronized void initIfNeeded() {
        if (this.ranges.isEmpty()) {
            ...
            add(new int[]{385}, "HR");
            add(new int[]{387}, "BA");
            add(new int[]{CanCameraUI.BTN_TRUMPCHI_GS4_MODE1, 440}, "DE");
            ...
            add(new int[]{628}, "SA");
            add(new int[]{629}, "AE");
            add(new int[]{CanCameraUI.BTN_LANDWIND_2D3D, CanCameraUI.BTN_LANDWIND_3D_LEFT_DOWN}, "FI");
            add(new int[]{690, 695}, "CN");
            add(new int[]{CanCameraUI.BTN_CC_WC_DIRECTION1, 709}, "NO");
            add(new int[]{729}, "IL");
            ...
            add(new int[]{759}, "VE");
            add(new int[]{760, KeyDef.SKEY_POWEWR_1}, "CH");
            add(new int[]{770}, "CO");
            add(new int[]{773}, "UY");
            add(new int[]{775}, "PE");
            add(new int[]{777}, "BO");
            ...
            add(new int[]{785}, "PE");
            add(new int[]{786}, "EC");
            add(new int[]{KeyDef.SKEY_SEEKDN_1, KeyDef.SKEY_SEEKDN_2}, "BR");
            add(new int[]{800, KeyDef.SKEY_RETURN_1}, "IT");
            add(new int[]{KeyDef.SKEY_RETURN_2, 849}, "ES");
            add(new int[]{850}, "CU");
            add(new int[]{858}, "SK");
            add(new int[]{859}, "CZ");
            add(new int[]{860}, "YU");
            ...
            add(new int[]{896}, "PK");
            add(new int[]{899}, "ID");
            add(new int[]{CanCameraUI.BTN_CS75_WC_MODE, 919}, "AT");
