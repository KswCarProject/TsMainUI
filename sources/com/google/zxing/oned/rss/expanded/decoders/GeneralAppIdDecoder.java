...
final class GeneralAppIdDecoder {
    ...
    private DecodedChar decodeIsoIec646(int pos) throws FormatException {
        ...
        switch (extractNumericValueFromBitArray(pos, 8)) {
            case Can.CAN_FLAT_WC /*232*/:
                c = '!';
                break;
            case Can.CAN_SGMW_WC /*233*/:
                c = '\"';
                break;
            case Can.CAN_LIEBAO_WC /*234*/:
                c = '%';
                break;
            case Can.CAN_ZH_WC /*235*/:
                c = '&';
                break;
            case Can.CAN_CHRYSLER_ONE_HC /*236*/:
                c = '\'';
                break;
            case Can.CAN_NISSAN_RICH6_WC /*237*/:
                c = '(';
                break;
            case Can.CAN_SE_DX7_RZC /*238*/:
                c = ')';
                break;
            ...
            case Can.CAN_BYD_M6_DJ /*244*/:
                c = '/';
                break;
            case Can.CAN_FORD_MONDEO_XFY /*245*/:
                c = ':';
                break;
            case Can.CAN_CHRYSLER_TXB /*246*/:
                c = ';';
                break;
            case Can.CAN_FORD_EDGE_XFY /*247*/:
                c = '<';
                break;
            case Can.CAN_RENAUL_KOLEOS_XFY /*248*/:
                c = '=';
                break;
            case Can.CAN_LUXGEN_WC /*249*/:
                c = '>';
                break;
            case Can.CAN_NISSAN_XFY /*250*/:
                c = '?';
                break;
            case Can.CAN_MG_ZS_WC /*251*/:
                c = '_';
                break;
            case Can.CAN_TOYOTA_SP_XP /*252*/:
                c = ' ';
                break;
            default:
