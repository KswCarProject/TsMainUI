    ...
    public ExpandedProductParsedResult parse(Result result) {
        ...
        while (i < rawText.length()) {
            ...
            if (ai != null) {
                ...
                char c = 65535;
                switch (ai.hashCode()) {
                    case CanToyotaDJCarDeviceView.ITEM_FF /*1536*/:
                        if (ai.equals("00")) {
                            c = 0;
                            break;
                        }
                    ...
                    case CanCameraUI.BTN_LANDWINDOD_3D_FRONT /*1567*/:
                        ...
                        break;
                    case CanCameraUI.BTN_LANDWINDOD_3D_LEFT_UP /*1568*/:
                        if (ai.equals("11")) {
                            c = 3;
                            break;
                        }
                        break;
                    case CanCameraUI.BTN_LANDWINDOD_3D_LEFT_DOWN /*1570*/:
                        if (ai.equals("13")) {
                            c = 4;
                            break;
                        }
                        break;
                    case CanCameraUI.BTN_LANDWINDOD_3D_REAR /*1572*/:
                        if (ai.equals("15")) {
                            c = 5;
                            break;
                        }
