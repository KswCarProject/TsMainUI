...
public class T implements Tr {
    ...
    protected final boolean f343T;

    public T(boolean loggingEnabled) {
        this.f343T = loggingEnabled;
    }
    ...
    public Bitmap T(Ty decodingInfo) throws IOException {
        ...
        try {
            ...
            Bitmap decodedBitmap = BitmapFactory.decodeStream(imageStream, (Rect) null, T(imageInfo.f345T, decodingInfo));
            if (decodedBitmap != null) {
                return T(decodedBitmap, decodingInfo, imageInfo.Tr.f344T, imageInfo.Tr.Tr);
            }
    ...
    public Tr T(InputStream imageStream, Ty decodingInfo) throws IOException {
        ...
        return new Tr(new T9(options.outWidth, options.outHeight, exif.f344T), exif);
    }
    ...
    public com.Ty.T.Tr.Tr.T.C0012T T(java.lang.String r9) {
        /*
            ...
            com.Ty.T.Tr.Tn.Tr$T r5 = com.Ty.T.Tr.Tn.Tr.T.FILE     // Catch:{ IOException -> 0x002e }
            java.lang.String r5 = r5.Ty(r9)     // Catch:{ IOException -> 0x002e }
