...
final class T9 {
    ...
    private static final int[][] f265T = {new int[]{1, 1, 1, 1, 1, 1, 1}, new int[]{1, 0, 0, 0, 0, 0, 1}, new int[]{1, 0, 1, 1, 1, 0, 1}, new int[]{1, 0, 1, 1, 1, 0, 1}, new int[]{1, 0, 1, 1, 1, 0, 1}, new int[]{1, 0, 0, 0, 0, 0, 1}, new int[]{1, 1, 1, 1, 1, 1, 1}};
    ...
    private static void Tn(int xStart, int yStart, Tr matrix) {
        for (int y = 0; y < 7; y++) {
            for (int x = 0; x < 7; x++) {
                matrix.T(xStart + x, yStart + y, f265T[y][x]);
            }
        }
    }

    private static void Tn(Tr matrix) throws TE {
        int pdpWidth = f265T[0].length;
        Tn(0, 0, matrix);
