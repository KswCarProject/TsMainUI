...
public final class Tr {
    ...
    private final byte[][] f270T;
    private final int Tr;
    private final int Ty;

    public Tr(int width, int height) {
        this.f270T = (byte[][]) Array.newInstance(Byte.TYPE, new int[]{height, width});
        this.Tr = width;
        this.Ty = height;
    }
