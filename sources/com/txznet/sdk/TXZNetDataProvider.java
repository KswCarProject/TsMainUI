...
public class TXZNetDataProvider {
    ...
    private static TXZNetDataProvider f772T;
            ...
            public void T(Tn.Ty data) {
                if (data != null) {
                    synchronized (TXZNetDataProvider.this.Tr) {
                        ...
                        if (remoteTask != null) {
                            remoteTask.f779T = data.Ty().intValue();
                        }
                    }
                }
                if (callback != null && T()) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:14:0x0057, code lost:
        if ("weather".equals(r12) == false) goto L_0x007a;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:15:0x0059, code lost:
        r2 = (java.lang.String) r0.T("data", java.lang.String.class);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:20:0x0081, code lost:
        if ("traffic".equals(r12) == false) goto L_0x009c;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:28:0x00a3, code lost:
        if ("flowInfo".equals(r12) == false) goto L_0x006e;
     */
    ...
    public byte[] notifyCallback(java.lang.String r12, byte[] r13) {
        /*
            ...
            monitor-enter(r8)
            java.util.Map<java.lang.Integer, com.txznet.sdk.TXZNetDataProvider$T> r7 = r11.Tr     // Catch:{ all -> 0x0099 }
            java.util.Set r7 = r7.keySet()     // Catch:{ all -> 0x0099 }
            java.util.Iterator r9 = r7.iterator()     // Catch:{ all -> 0x0099 }
        L_0x000d:
            boolean r7 = r9.hasNext()     // Catch:{ all -> 0x0099 }
            if (r7 == 0) goto L_0x0077
            java.lang.Object r3 = r9.next()     // Catch:{ all -> 0x0099 }
            java.lang.Integer r3 = (java.lang.Integer) r3     // Catch:{ all -> 0x0099 }
            java.util.Map<java.lang.Integer, com.txznet.sdk.TXZNetDataProvider$T> r7 = r11.Tr     // Catch:{ all -> 0x0099 }
            java.lang.Object r5 = r7.get(r3)     // Catch:{ all -> 0x0099 }
            com.txznet.sdk.TXZNetDataProvider$T r5 = (com.txznet.sdk.TXZNetDataProvider.T) r5     // Catch:{ all -> 0x0099 }
            if (r5 == 0) goto L_0x000d
            com.txznet.sdk.TXZNetDataProvider$NetDataCallback r7 = r5.Tr     // Catch:{ all -> 0x0099 }
            if (r7 == 0) goto L_0x000d
            com.txznet.comm.Ty.Tr r0 = new com.txznet.comm.Ty.Tr     // Catch:{ all -> 0x0099 }
            r0.<init>((byte[]) r13)     // Catch:{ all -> 0x0099 }
            java.lang.String r7 = "rc"
            java.lang.Class<java.lang.Integer> r10 = java.lang.Integer.class
            java.lang.Object r7 = r0.T((java.lang.String) r7, r10)     // Catch:{ all -> 0x0099 }
            java.lang.Integer r7 = (java.lang.Integer) r7     // Catch:{ all -> 0x0099 }
            int r4 = r7.intValue()     // Catch:{ all -> 0x0099 }
            java.lang.String r7 = "taskId"
            java.lang.Class<java.lang.Integer> r10 = java.lang.Integer.class
            java.lang.Object r7 = r0.T((java.lang.String) r7, r10)     // Catch:{ all -> 0x0099 }
            java.lang.Integer r7 = (java.lang.Integer) r7     // Catch:{ all -> 0x0099 }
            int r6 = r7.intValue()     // Catch:{ all -> 0x0099 }
            int r7 = r5.f779T     // Catch:{ all -> 0x0099 }
            if (r7 != r6) goto L_0x000d
            if (r4 != 0) goto L_0x00bb
            java.lang.String r7 = "weather"
            boolean r7 = r7.equals(r12)     // Catch:{ all -> 0x0099 }
            if (r7 == 0) goto L_0x007a
            java.lang.String r7 = "data"
            java.lang.Class<java.lang.String> r9 = java.lang.String.class
            java.lang.Object r2 = r0.T((java.lang.String) r7, r9)     // Catch:{ all -> 0x0099 }
            java.lang.String r2 = (java.lang.String) r2     // Catch:{ all -> 0x0099 }
            com.txznet.sdk.TXZNetDataProvider$4 r7 = new com.txznet.sdk.TXZNetDataProvider$4     // Catch:{ all -> 0x0099 }
            r7.<init>(r5, r2)     // Catch:{ all -> 0x0099 }
            r9 = 0
            com.txznet.T.T.Ty(r7, r9)     // Catch:{ all -> 0x0099 }
        L_0x006e:
            java.util.Map<java.lang.Integer, com.txznet.sdk.TXZNetDataProvider$T> r7 = r11.Tr     // Catch:{ all -> 0x0099 }
            java.lang.Integer r9 = java.lang.Integer.valueOf(r6)     // Catch:{ all -> 0x0099 }
            r7.remove(r9)     // Catch:{ all -> 0x0099 }
        L_0x0077:
        ...
        L_0x007a:
            ...
            java.lang.Object r2 = r0.T((java.lang.String) r7, r9)     // Catch:{ all -> 0x0099 }
            java.lang.String r2 = (java.lang.String) r2     // Catch:{ all -> 0x0099 }
            com.txznet.sdk.TXZNetDataProvider$5 r7 = new com.txznet.sdk.TXZNetDataProvider$5     // Catch:{ all -> 0x0099 }
            r7.<init>(r5, r2)     // Catch:{ all -> 0x0099 }
            r9 = 0
            com.txznet.T.T.Ty(r7, r9)     // Catch:{ all -> 0x0099 }
            goto L_0x006e
        ...
        L_0x009c:
            ...
            java.lang.Object r2 = r0.T((java.lang.String) r7, r9)     // Catch:{ all -> 0x0099 }
            java.lang.String r2 = (java.lang.String) r2     // Catch:{ all -> 0x0099 }
            com.txznet.sdk.TXZNetDataProvider$6 r7 = new com.txznet.sdk.TXZNetDataProvider$6     // Catch:{ all -> 0x0099 }
            r7.<init>(r5, r2)     // Catch:{ all -> 0x0099 }
            r9 = 0
            com.txznet.T.T.Ty(r7, r9)     // Catch:{ all -> 0x0099 }
            goto L_0x006e
        L_0x00bb:
            ...
            java.lang.Object r7 = r0.T((java.lang.String) r7, r9)     // Catch:{ all -> 0x0099 }
            java.lang.Integer r7 = (java.lang.Integer) r7     // Catch:{ all -> 0x0099 }
            int r1 = r7.intValue()     // Catch:{ all -> 0x0099 }
            com.txznet.sdk.TXZNetDataProvider$NetDataCallback r7 = r5.Tr     // Catch:{ all -> 0x0099 }
            r7.onError(r1)     // Catch:{ all -> 0x0099 }
            goto L_0x006e
        */
