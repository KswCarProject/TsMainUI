...
public class T9 {
    ...
    private static Class<?> f391T = null;
    ...
    private static int T(int type, int val, String[] attrs) {
        if (com.txznet.comm.Tr.T.T()) {
            try {
                if (f391T == null || Tr == null) {
                    f391T = Class.forName("com.txznet.txz.jni.JNIHelper");
                    Tr = f391T.getMethod("monitor", new Class[]{Integer.TYPE, Integer.TYPE, String[].class});
                }
                Tr.invoke(f391T, new Object[]{Integer.valueOf(type), Integer.valueOf(val), attrs});
            } catch (Exception e) {
            }
        } else {
            try {
                ...
                json.T("type", (Object) Integer.valueOf(type));
