...
public class T2 implements T7 {
    ...
    public static final T2 f139T = new T2();
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:54:0x0176, code lost:
        if (r2 == null) goto L_0x017f;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:56:0x017a, code lost:
        if ((r15 instanceof java.lang.Integer) != false) goto L_0x017f;
     */
    ...
    public static java.util.Map T(com.T.T.Tr.Ty r12, java.util.Map<java.lang.String, java.lang.Object> r13, java.lang.reflect.Type r14, java.lang.Object r15) {
        ...
        L_0x002d:
            r5.Tx()     // Catch:{ all -> 0x0081 }
            char r0 = r5.Te()     // Catch:{ all -> 0x0081 }
            com.T.T.Tr.Tn r9 = com.T.T.Tr.Tn.AllowArbitraryCommas     // Catch:{ all -> 0x0081 }
            boolean r9 = r12.T((com.T.T.Tr.Tn) r9)     // Catch:{ all -> 0x0081 }
            if (r9 == 0) goto L_0x004b
        L_0x003c:
            r9 = 44
            if (r0 != r9) goto L_0x004b
            r5.Tq()     // Catch:{ all -> 0x0081 }
            r5.Tx()     // Catch:{ all -> 0x0081 }
            char r0 = r5.Te()     // Catch:{ all -> 0x0081 }
            goto L_0x003c
        L_0x004b:
            ...
            com.T.T.Tr.Th r9 = r12.Tr()     // Catch:{ all -> 0x0081 }
            r10 = 34
            java.lang.String r4 = r5.T(r9, r10)     // Catch:{ all -> 0x0081 }
            r5.Tx()     // Catch:{ all -> 0x0081 }
            char r0 = r5.Te()     // Catch:{ all -> 0x0081 }
            r9 = 58
            if (r0 == r9) goto L_0x0129
            com.T.T.Tn r9 = new com.T.T.Tn     // Catch:{ all -> 0x0081 }
            ...
            int r11 = r5.Tk()     // Catch:{ all -> 0x0081 }
            java.lang.StringBuilder r10 = r10.append(r11)     // Catch:{ all -> 0x0081 }
            java.lang.String r10 = r10.toString()     // Catch:{ all -> 0x0081 }
            r9.<init>(r10)     // Catch:{ all -> 0x0081 }
        ...
        L_0x0086:
            ...
            r5.Tq()     // Catch:{ all -> 0x0081 }
            r5.TF()     // Catch:{ all -> 0x0081 }
            r9 = 16
            r5.T((int) r9)     // Catch:{ all -> 0x0081 }
            r12.T((com.T.T.Tr.T5) r2)
        L_0x0098:
            return r13
        L_0x0099:
            ...
            com.T.T.Tr.Tn r9 = com.T.T.Tr.Tn.AllowSingleQuotes     // Catch:{ all -> 0x0081 }
            boolean r9 = r12.T((com.T.T.Tr.Tn) r9)     // Catch:{ all -> 0x0081 }
        ...
        L_0x00ad:
            ...
            throw r9     // Catch:{ all -> 0x0081 }
        L_0x00df:
            com.T.T.Tr.Tn r9 = com.T.T.Tr.Tn.AllowUnQuotedFieldNames     // Catch:{ all -> 0x0081 }
            boolean r9 = r12.T((com.T.T.Tr.Tn) r9)     // Catch:{ all -> 0x0081 }
        ...
        L_0x00ef:
            com.T.T.Tr.Th r9 = r12.Tr()     // Catch:{ all -> 0x0081 }
            java.lang.String r4 = r5.Tr((com.T.T.Tr.Th) r9)     // Catch:{ all -> 0x0081 }
            r5.Tx()     // Catch:{ all -> 0x0081 }
            char r0 = r5.Te()     // Catch:{ all -> 0x0081 }
            r9 = 58
            if (r0 == r9) goto L_0x0129
            ...
            java.lang.StringBuilder r10 = r10.append(r11)     // Catch:{ all -> 0x0081 }
            java.lang.StringBuilder r10 = r10.append(r0)     // Catch:{ all -> 0x0081 }
            java.lang.String r10 = r10.toString()     // Catch:{ all -> 0x0081 }
            r9.<init>(r10)     // Catch:{ all -> 0x0081 }
            throw r9     // Catch:{ all -> 0x0081 }
        L_0x0129:
            ...
            char r0 = r5.Te()     // Catch:{ all -> 0x0081 }
            r5.TF()     // Catch:{ all -> 0x0081 }
            java.lang.String r9 = com.T.T.T.f128T     // Catch:{ all -> 0x0081 }
            if (r4 != r9) goto L_0x018b
            com.T.T.Tr.Th r9 = r12.Tr()     // Catch:{ all -> 0x0081 }
            r10 = 34
            java.lang.String r7 = r5.T(r9, r10)     // Catch:{ all -> 0x0081 }
            java.lang.Class r1 = com.T.T.Tn.TZ.T((java.lang.String) r7)     // Catch:{ all -> 0x0081 }
            java.lang.Class r9 = r13.getClass()     // Catch:{ all -> 0x0081 }
            if (r1 != r9) goto L_0x0165
            r9 = 16
            r5.T((int) r9)     // Catch:{ all -> 0x0081 }
            int r9 = r5.Tn()     // Catch:{ all -> 0x0081 }
            r10 = 13
            ...
            goto L_0x0098
        L_0x0165:
            com.T.T.Tr.Tv r9 = r12.Ty()     // Catch:{ all -> 0x0081 }
            com.T.T.Tr.T.T7 r3 = r9.T((java.lang.reflect.Type) r1)     // Catch:{ all -> 0x0081 }
            r9 = 16
            r5.T((int) r9)     // Catch:{ all -> 0x0081 }
            r9 = 2
            r12.T((int) r9)     // Catch:{ all -> 0x0081 }
            if (r2 == 0) goto L_0x017f
            boolean r9 = r15 instanceof java.lang.Integer     // Catch:{ all -> 0x0081 }
            if (r9 != 0) goto L_0x017f
            r12.T5()     // Catch:{ all -> 0x0081 }
        L_0x017f:
            java.lang.Object r9 = r3.T(r12, r1, r15)     // Catch:{ all -> 0x0081 }
            java.util.Map r9 = (java.util.Map) r9     // Catch:{ all -> 0x0081 }
            r12.T((com.T.T.Tr.T5) r2)
            r13 = r9
            goto L_0x0098
        L_0x018b:
            r5.T()     // Catch:{ all -> 0x0081 }
            int r9 = r5.Tn()     // Catch:{ all -> 0x0081 }
            r10 = 8
            ...
            r5.T()     // Catch:{ all -> 0x0081 }
        L_0x019a:
            r13.put(r4, r8)     // Catch:{ all -> 0x0081 }
            r12.T((java.util.Map) r13, (java.lang.String) r4)     // Catch:{ all -> 0x0081 }
            r12.T((com.T.T.Tr.T5) r2, (java.lang.Object) r8, (java.lang.Object) r4)     // Catch:{ all -> 0x0081 }
            int r6 = r5.Tn()     // Catch:{ all -> 0x0081 }
            r9 = 20
        ...
        L_0x01af:
            ...
            goto L_0x0098
        L_0x01b4:
            java.lang.Object r8 = r12.T((java.lang.reflect.Type) r14)     // Catch:{ all -> 0x0081 }
            goto L_0x019a
        L_0x01b9:
            r9 = 13
            ...
            while (lexer.Tn() != 13) {
                try {
                    if (lexer.Tn() != 4 || !lexer.TN()) {
                        if (map.size() == 0 && lexer.Tn() == 4 && T.f128T.equals(lexer.Tf())) {
                            lexer.Tr(4);
                            lexer.T(16);
                            if (lexer.Tn() == 13) {
                                lexer.T();
