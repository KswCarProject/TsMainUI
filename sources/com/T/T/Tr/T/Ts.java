...
public abstract class Ts {
    ...
    public Ts(Class<?> clazz, Ty fieldInfo) {
        this.Tr = clazz;
        this.f173T = fieldInfo;
    }

    public Method Tr() {
        return this.f173T.Tn();
    }

    public Field Ty() {
        return this.f173T.T9();
    }
    ...
    public void T(Object object, Object value) {
        ...
        if (method != null) {
            try {
                ...
                throw new Tn("set property error, " + this.f173T.Ty(), e);
            }
        } else {
            Field field = this.f173T.T9();
            if (field != null) {
                try {
                    field.set(object, value);
                } catch (Exception e2) {
                    throw new Tn("set property error, " + this.f173T.Ty(), e2);
                }
            }
        }
    }
