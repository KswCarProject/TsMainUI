...
public class KeyEventCompat {
    ...
    static class BaseKeyEventVersionImpl implements KeyEventVersionImpl {
        ...
        public int normalizeMetaState(int metaState) {
            ...
            return metaState & Can.CAN_FORD_EDGE_XFY;
        }

        public boolean metaStateHasModifiers(int metaState, int modifiers) {
            if (metaStateFilterDirectionalModifiers(metaStateFilterDirectionalModifiers(normalizeMetaState(metaState) & Can.CAN_FORD_EDGE_XFY, modifiers, 1, 64, 128), modifiers, 2, 16, 32) == modifiers) {
                return true;
            }
            return false;
        }
        ...
        public boolean metaStateHasNoModifiers(int metaState) {
            return (normalizeMetaState(metaState) & Can.CAN_FORD_EDGE_XFY) == 0;
        }
